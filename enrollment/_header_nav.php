<nav class="navbar navbar-full navbar-dark bg-primary" id="stciky">
    ...
    <div class="navbar-collapse" id="mainNavbarCollapse">
        <ul class="nav navbar-nav" id="menu">
            <li class="nav-item">
                <?php $class = ( strpos($_SERVER['REQUEST_URI'],'success.php') !== false ) ? 'nav-active' : ''?>
                <a class="header_icon_box1 <?=$class?>" <?php //href="success.php" ?>><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="22px" height="22px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
...
<div class="row notice-banner" id="stopLinkMsg">
    <div class="alert alert-warning alert-dismissible">
        ...
        Your enrollment form with Prescription Hope was denied. If you feel this was an error or want more information on why your enrollment form got denied, please contact us at <a href="tel:18772964673">1-877-296-HOPE(4673)</a>. If your situation has changed and you would like to submit a new enrollment form, please reapply.
        <p style="margin:20px 0 10px 0;">
            <form method="post" action="reapply.php">
                <input type="hidden" name="pid" id="pid" value="<?= $_SESSION[$session_key]['data']['id']?>" />
                <input type="hidden" name="email" id="email" value="<?= $_SESSION[$session_key]['data']['email']?>" />
                <input type="hidden" name="type" id="type" value="denied" />
                <button type="submit" class="btn_blue bold underline">Reapply Here</button>
            </form>
        </p>
    </div>
</div>
<?php } else { ?>
<div class="row notice-banner" id="stopLinkMsg">
    <div class="alert alert-warning alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close"><i class="fa fa-close"></i></a>Your enrollment is currently processing. You will be contacted via phone and email to let you know if your enrollment is pre-approved or denied.</div>
</div>
<?php } ?>
...
jQuery(document).ready(function(){
    jQuery('a.header_icon_box1').click(function(e){ e.preventDefault();});
});
</script>