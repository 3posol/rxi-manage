                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="medication_content">
                                ...
                                <p class="my-3 prescription-hope-utilizes-u-s">Thank you <?= ucfirst($_SESSION[$session_key]['data']['first_name']) ?>, you have successfully submitted your enrollment form for Prescription Hope. Below you will<br/> see each of the medications you have requested and the current status of that medication.</p>
                            </div>
                        </div>
                    </div>
                </div>
