                                    ...
                                    <div class="patient_income_yes_only">
                                        ...
                                        <div class="radio-group p_medicaid_2nd">
                                            ...
                                            <div class="full-width align-left">
                                                ...
                                                <label for="p_lis_no" class='rb-container no_width'>No
                                                    <input autocomplete="nope" type="radio" data-type="patient" id="p_lis_no"  name="p_lis" value="0" checked="" class="radio-groups LoNotSensitive">
                                                    <span class="rb-checkmark"></span>
                                                </label>
                                            </div>
                                            <br>
                                        ...
                                        <?php foreach ($data['doctors'] as $dr_key => $doctor) { ?>
                                            <?php if ((count($data['doctors']) > 1 && $doctor['doctor_first_name'] != '' && $doctor['doctor_last_name'] != '') || count($data['doctors']) == 1) { ?>
                                                ...
                                                <div old-id="doctor_form" role="tabpanel" class="dr-form tab-pane fade in <?php echo $addClass; ?>" id="pb<?= ($valid_drs) ?>">
                                                    ...
                                                    <div>										
                                                        <div class="half-width doctor-phone-field"><input autocomplete="nope" type="text" name="doctor_phone[<?= $valid_drs ?>]" value="<?= $doctor['doctor_phone'] ?>" class="doctor_phone-<?= $valid_drs ?> dr-required dr-data dr-phone LoNotSensitive patient-enroll-progress-4" placeholder="Phone Number *" title="Phone Number *" data-step-enroll="4"></div>
                            ...
                            <div class="col-sm-7 card-form">
                                <?php if (!(isset($agent_details['use_payment']) && (bool) $agent_details['use_payment'])) { ?>
                                    ...
                                    <!--select data-type="patient" name="p_cc_exp_year" preload="<?php echo $data['p_cc_exp_year']; ?>" class="full-width" placeholder="Credit Card Expiration Year *">
                                            ...
                                            <div>	
                                                <div class="full-width doctor-address-field"><input autocomplete="nope" type="text" name="p_cc_name" value="<?= $data['p_cc_name'] ?>" class=" LoNotSensitive patient-enroll-progress-4" placeholder="Name of Cardholder *" title="Name of Cardholder" rel="" data-step-enroll="4" data-type="patient"></div>
                                                <div class="full-width doctor-address-field"><input autocomplete="nope" type="text" name="p_cc_address" id="p_cc_address" value="<?= $data['p_cc_address'] ?>" class=" LoNotSensitive patient-enroll-progress-4" placeholder="Address of Cardholder *" title="Address of Cardholder *" rel="" data-step-enroll="4" data-type="patient"></div>
                                            </div>

                                            <div>										
                                                <div class="half-width doctor-address2-field"><input autocomplete="nope" type="text" name="p_cc_address2" value="<?= $data['p_cc_address2'] ?>" class=" LoNotSensitive" placeholder="Apartment, Suite, Unit, etc. (optional)" title="Suite Number" data-type="patient"></div>
                                                <div class="half-width doctor-city-field"><input autocomplete="nope" type="text" name="p_cc_city" id="p_cc_city" value="<?= $data['p_cc_city'] ?>" class=" LoNotSensitive patient-enroll-progress-4" placeholder="City of Cardholder *" title="City of Cardholder *" data-step-enroll="4"  data-type="patient"></div>
                                            </div>									

                                            <div>										
                                                <div class="half-width doctor-state-field">
                                                    <select name="p_cc_state" id="p_cc_state" preload="<?= $data['p_cc_state'] ?>" class=" full-width LoNotSensitive" placeholder="State of Cardholder *" title="State of Cardholder *" data-type="patient">
                                                        <option value="" selected="selected"></option>
                                                        <option value="AL">Alabama</option>
                                                        <option value="AK">Alaska</option>
                                                        <option value="AZ">Arizona</option>
                                                ...
                                                <div class="half-width doctor-zip-field"><input autocomplete="nope" type="text" name="p_cc_zip" id="p_cc_zip" value="<?= $data['p_cc_zip'] ?>" maxlength="5" class=" LoNotSensitive patient-enroll-progress-4" placeholder="Zip Code of Cardholder *" title="Zip Code of Cardholder *" data-step-enroll="4"  data-type="patient"></div>
                                            </div>
                                ...
                                <div class="term-content">
                                    ...
                                    <div class="submit-form">
                                        <div class="btn-en-group col-sm-12 submit_button">
                                            <input autocomplete="nope" type="hidden" name="bSubmit" value="Submit" />	
                                            <input autocomplete="nope" type="button" name="bSubmit_btn" id="bSubmit" value="Submit" class="btn btn-primary next btn-block mv-10" disabled="disabled">	
                                            <a class="back cg_back" href="javascript:;">Back</a>		
                                        </div>
                                        <input type="hidden" id="removepb" value="" />				
                                        <div><div id="ttt" style="color: #fff;"></div></div>
