		...
		<div class="content createAccountBox align-center">
			<div id='applicationForm'>
				<?php if (!$form_submitted) { ?>
					...
					<h2 class=" dblue-text no-text-transformation">Monthly Income Information</h2>

					<p class="normal align-left">
						Your monthly income verification is required by the pharmaceutical company to process your medication orders. It will not be used for any other purposes and will remain confidential.
					</p>
