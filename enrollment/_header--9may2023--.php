...
<![endif]-->
<!--[if !(IE 7) | !(IE 8) | !(IE 9)  ]><!-->
<html lang="en-US" prefix="og: http://ogp.me/ns#" class="<?php echo (isset($_GET['iframe']) && $_GET['iframe'] == 1) ? "iframe_html" : "" ?>">
    <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/ph-style.css">
...
//} 
        ...
        <?php $rand = "?v=" . ((isset($_GET['rand'])) ? rand() : "5" ); ?>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-1044900775"></script> 
    <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-1044900775'); </script> 

        <?php if(isset($body_class) && $body_class == 'verification_body'): ?>
        <!-- Event snippet for Submit Application (USE) conversion page --> 
        <script> gtag('event', 'conversion', {'send_to': 'AW-1044900775/a6KACJXpl3YQp9ef8gM'}); </script>
    ...
    <body class="<?php echo $bodyClass ?> <?php echo (isset($_GET['iframe']) && $_GET['iframe'] == 1) ? "iframe_body" : "" ?> <?php echo (isset($body_class))?$body_class:'' ?>">
            ...
            <nav class="navbar-default  header-nav" role="navigation">
                <div class="container container-main">
                    ...
                    <div class="login-scren">  <?php if ($patient_logged_in) { ?>
                        ...
                        <?php } else { ?>
                            <div class="login-with-header"><a href="../patients-dashboard/login.php" class="right top-menu-login ">Member Log In</a></div>
                        <?php } ?></div>
                    <div class="menu-list">
                        <ul>
                            <!--<li><a href="https://prescriptionhope.com/help" target="_blank">Help</a></li>-->
                            <li class="mbl_head_phn"><a href="tel:1-877-296-4673">1-877-296-4673</a></li>
                        </ul>
