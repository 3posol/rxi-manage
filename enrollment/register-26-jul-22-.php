                ...
                <form role="form" id="fmRegister" method="POST" autocomplete="nope">
                    ...
                    <div class="colorgraph col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">				
                                <div class="form-group">
                                    <input autocomplete="nope" type="text" name="address" id="p_address" class="jvf form-control input-lg" placeholder="Street Address *" tabindex="9" value="<?= addslashes($data['address']) ?>" data-hintold="Enter a valid address.">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">				
                                <div class="form-group">
                                    <input autocomplete="nope" type="text" name="address2" id="p_address2" class="jvf form-control input-lg" placeholder="Apartment, Suite, Unit, etc. (optional)" tabindex="10" value="<?= addslashes($data['address2']) ?>" data-hintold="Enter a valid address.">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4">				
                                <div class="form-group">
                                    <input autocomplete="nope" type="text" name="city" id="p_city" class="jvf form-control input-lg" placeholder="City *" tabindex="11" value="<?= addslashes($data['city']) ?>" data-hintold="Enter a valid city.">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4">				
                                <div class="form-group">
                                    <select name="state" id="p_state" preload="State" class="" placeholder="State *" title="State *" tabindex="12">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4">				
                                <div class="form-group">
                                    <input autocomplete="nope" type="text" name="zipcode" id="p_zipcode" class="jvf form-control input-lg" placeholder="Zip Code *" tabindex="13" value="<?= addslashes($data['zipcode']) ?>" data-hintold="Enter a valid zipcode.">
                                </div>
                            </div>	
                        </div>
                        ...
                        <div class="form-group radio-group">
                            <div class="maxl">
                                <div class="form-row1">
                                    ...
                                    <div class="full-width align-left">
                                        <input type="hidden" data-f-count="2" data-fl_1="gender_m" data-fl_2="gender_f" class="patient-enroll-progress-2" data-step-enroll="2">
                                        <label for="gender_m" class='rb-container no_width'>Male
                                            <input autocomplete="nope" type="radio" tabindex="14" data-type="patient" id="gender_m" name="gender" value="M" <?= ($data['gender'] && $data['gender'] == 'M') ? 'checked' : '' ?> class="LoNotSensitive" preload="" >
                                            <span class="rb-checkmark"></span>
                                        </label>
                                        <label for="gender_f" class='rb-container no_width'>Female
                                            <input autocomplete="nope" type="radio" tabindex="15" data-type="patient" id="gender_f" name="gender" value="F" <?= ($data['gender'] && $data['gender'] == 'F') ? 'checked' : '' ?> class="LoNotSensitive " >
                                            <span class="rb-checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="form-group radio-group">
                            <div class="maxl">
                                ...
                                <div class="full-width align-left">
                                    <input type="hidden" data-f-count="2" data-fl_1="is_minor_yes" data-fl_2="is_minor_no" class="patient-enroll-progress-2" data-step-enroll="2">
                                    <label for="is_minor_yes" class='rb-container no_width'>Yes
                                        <input onchange="changeIsMinor()" autocomplete="nope" type="radio" tabindex="16" data-type="patient" id="is_minor_yes" name="is_minor" value="1" <?= ($data['is_minor'] == '1') ? 'checked' : '' ?> class="LoNotSensitive " <?php echo ((in_array('is_minor', $radios_submitted) && $data['is_minor'] != '') ? 'preload="' . (int) $data['is_minor'] . '"' : ''); ?> >
                                        <span class="rb-checkmark"></span>
                                    </label>
                                    <label for="is_minor_no" class='rb-container no_width'>No
                                        <input onchange="changeIsMinor()" autocomplete="nope" type="radio" tabindex="17" data-type="patient" id="is_minor_no" name="is_minor" value="0" <?= ($data['is_minor'] == '0') ? 'checked' : '' ?> class="LoNotSensitive " >
                                        <span class="rb-checkmark"></span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-row1 patient_parent_profile no-show">
                            <div class="form-group">
                                <div class="full-width">
                                    <input autocomplete="nope" type="text" tabindex="18" data-type="patient" id="p_parent_first_name" name="p_parent_first_name" value="<?php echo htmlspecialchars(stripslashes($data['parent_first_name'])); ?>" class="LoNotSensitive" placeholder="Parent/Guardian First Name *" title="Parent/Guardian First Name *">
                                </div>
                            </div>	
                            <div class="form-group">	
                                <div class="full-width">
                                    <input autocomplete="nope" type="text" tabindex="19" data-type="patient" id="p_parent_middle_initial" name="p_parent_middle_initial" value="<?php echo htmlspecialchars(stripslashes($data['parent_middle_initial'])); ?>" maxlength="1" class="LoNotSensitive" placeholder="Parent/Guardian Middle Initial" title="Parent/Guardian Middle Initials">
                                </div>
                            </div>
                            <div class="form-group">	
                                <div class="full-width">
                                    <input autocomplete="nope" type="text" tabindex="20" data-type="patient" id="p_parent_last_name" name="p_parent_last_name" value="<?php echo htmlspecialchars(stripslashes($data['parent_last_name'])); ?>" class="LoNotSensitive" placeholder="Parent/Guardian Last Name *" title="Parent/Guardian Last Name *">
                                </div>
                            </div>
                            <div class="clear"></div>

                            <input autocomplete="nope" type="text" tabindex="21" data-type="patient" id="p_parent_phone" name="p_parent_phone" value="<?php echo $data['parent_phone']; ?>" class="LoNotSensitive customphone" placeholder="Parent/Guardian Phone *" title="Parent/Guardian Phone *">
                        </div>
                        <div class="form-group">
                                    <div class="full-width"><input tabindex="22" autocomplete="nope" type="text" data-type="patient" name="alternate_contact_name" value="<?php echo htmlspecialchars(stripslashes($data['alternate_contact_name'])); ?>" class="LoNotSensitive" placeholder="Alternate Contact Name" title="Alternate Contact Name"></div>
                                </div>
                                <div class="form-group">
                                    <div class="full-width"><input tabindex="23" autocomplete="nope" type="text" data-type="patient" name="alternate_phone" value="<?php echo $data['alternate_phone']; ?>" class="LoNotSensitive not_required_phone" placeholder="Alternate Contact Phone" title="Alternate Contact Phone"></div>
                                </div>
                        <div class="form-group">

                            <div class="full-width">
                                <select data-type="patient" name="p_hear_about" tabindex="24" id="p_hear_about" data-value="<?php echo htmlspecialchars(stripslashes($data['p_hear_about'])); ?>" class="full-width LoNotSensitive form-control patient-enroll-progress-2" placeholder="How did you hear about Prescription Hope? *" title="How did you hear about Prescription Hope? *" data-step-enroll="2">
                            ...
                            <div class="condition">
                                ...
                                <div class="form-check">	
                                    ...
                                    <label class="form-check-label cb-container checkbox-label" for="register_terms">
                                        <input type="checkbox" tabindex="25" class="form-check-input checkbox-normal" id="register_terms" name="register_terms"><span class="cb-checkmark"></span>								
                            ...
                            <div class="condition">
                                <div class="form-check">								
                                    <label class="form-check-label cb-container checkbox-label" for="ph_register_terms_email">
                                        <input type="checkbox" tabindex="26" class="form-check-input checkbox-normal" id="ph_register_terms_email" name="ph_register_terms_email"><span class="cb-checkmark"></span>								
                        ...
                        <div class="row">				
                            <div class="col-xs-12 col-sm-12 col-xs-12">
                                ...
                                <input tabindex="27" type="button" name="register_submit" id="btSubmit" value="Submit" class="big-button loginPageButton btn btn-default bt btn-block btn-lg">
