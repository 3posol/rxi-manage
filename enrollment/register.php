...
<script type="text/javascript"
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBOlfvGqz948FRGcCi35yHLbvWhLHHwSzQ&libraries=places"></script>
<style type="text/css">
html body h1,
html body h2,
html body h3,
...
<div class="container Form-register-section frs">
    <div class="">
        ...
        <div class="col-md-5 col-sm-12 col-xs-12 pull-left" id="testimonials-row">
            <div class="">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 brand-name-med-txt">
                    <h1 class="brand-name-med ">Brand-Name Medication</h1>
                    <h2>$50 A Month for Each Medication</h2>

                    <p>Prescription Hope provides access to over 1500 brand-name medications for only $50 a month per
                        medication
                        through Prescription Hope's medication access service. There are no other costs associated with
                        our service or your medications.</p>
                    <h3>Even if you take generic medications, we can help.</h3>
                </div>

                <div class=" column L10 ph-desktop-view">
                    <div class="See_How_Head">
                        <h3>See How Prescription Hope Works</h3>
                    </div>
                    ...
                    <!--                        <video id="click_data_med_temp" style="height: 280px;
    overflow: hidden;
    text-align: center;
    ...
    cursor: pointer;
    width: 101.3%;
        height: auto;" poster="https://prescriptionhope.com/wp-content/uploads/2022/09/banner_play.png" controls="controls" width="300" height="150"><source src="https://prescriptionhope.com/wp-content/uploads/2022/09/BlueExplainer-WithoutSlashAnimation.mp4" type="video/mp4" playsinline=""></video>
                    -->

                    <iframe id="click_data_med_temp" allowfullscreen=""
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        frameborder="0" title="YouTube video player"
                        src="https://www.youtube.com/embed/853PbD9qqjQ?loop=1&amp;playlist=853PbD9qqjQ" style="
    height: 280px;
    overflow: hidden;
    text-align: center;
    border-top-right-radius: 20px;
   ...
   "></iframe>
                    ...
                    <div id="owl-demo" class="owl-carousel owl-theme  bg-image-profile ">
                        <div class="item">
                            <div class="testimonials col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <h3>
                                    ...
                                    <span class="text-testimonials">When the rep from Prescription Hope called to tell
                                        me I was qualified, I was speechless. They saved our home, they saved my health,
                                        they lifted that enormous financial burden at a time when we needed it
                                        most.</span>
                        ...
                        <div class="item">
                            <div class="testimonials col-lg-12 col-md-12 col-sm-12  col-xs-12">
                                <h3>
                                    <span class="t1"><img src="/enrollment/images/Account/testimonial-arrow.png"></span>
                                    <span class="text-testimonials">Prescription Hope has allowed me and my family to do
                                        several other things because it has freed up funds from really expensive
                                        medication.</span>
                        ...
                        <div class="item">
                            <div class="testimonials col-lg-12 col-md-12 col-sm-12  col-xs-12">
                                <h3>
                                    <span class="t1"><img src="/enrollment/images/Account/testimonial-arrow.png"></span>
                                    <span class="text-testimonials">They were the most kind helpful people I have ever
                                        spoken with. The experience has been life-changing.</span>
        ...
        <div class=" col-md-7 col-sm-12 co-xs-12 pull-right enroll-form-1">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 get-started-register">
                    <h2 class="heading-title"><span><img src="/enrollment/images/Account/get-start-icon.png"></span>Get
                        Started</h2>

                    <div class="col-sm-12 pull-right">

                        <div class="text-content-text"><span>You are a few steps away from saving money on your
                                medication. To begin your enrollment, let's start with some contact information to
                ...
                <form role="form" id="fmRegister" method="POST" autocomplete="nope">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-sm-8 col-xs-12 pull-right">
                            <div class="text-content text-content-mac"><img src="images/safe.jpg"> <span>We keep your
                                    information safe and protected. It is secured by 256-bit encryption, the same
                                    security banks use.</span></div>
                    ...
                    <div class="colorgraph col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="">
                            <div id="fmMsg" role="alert" style="text-align: center;"
                                class="alert alert-info col-xs-12 col-sm-12 col-md-12 <?= (($message != '' && !$success) ? 'error' : 'bold') ?>">
                                <?= $message ?>
                            </div>
                        </div>
                        <?php } ?>
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" name="first_name"
                                        id="first_name" class="jvf form-control input-lg" placeholder="First Name *"
                                        tabindex="1" value="<?= addslashes($data['first_name']) ?>">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" name="middle_initial"
                                        id="middle_initial" class="jvf form-control input-lg" placeholder="Middle Name"
                                        tabindex="2" value="<?= addslashes($data['middle_initial']) ?>" maxlength="1">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" name="last_name"
                                        id="last_name" class="jvf form-control input-lg" placeholder="Last Name *"
                                        tabindex="3" value="<?= addslashes($data['last_name']) ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="email" name="email" id="email"
                                        class="jvf form-control input-lg" placeholder="Email Address *" tabindex="4"
                                        value="<?= addslashes($data['email']) ?>"
                                        data-hintold="Enter a valid email address. Your email address is required for communication regarding your medication orders and important updates about Prescription Hope.">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="email" name="email_confirm"
                                        id="email_confirm" class="jvf form-control input-lg"
                                        placeholder="Confirm Email Address *" tabindex="5"
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div id="capsInfo"
                                    style="color: blue;display: block;position: absolute;top: -19px;font-size: 13px;left: 37px;">
                                </div>
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="password"
                                        class="jvf form-control input-lg caps_check ttip" id="password" name="password"
                                        placeholder="Password *" data-text="Password Requirements"
                                        data-hint="Passwords must be 8-20 characters, contain a mix of uppercase and lowercase letters, and contain at least one number."
                                        tabindex="6" maxlength="20"><span class="showpassword" id="password_show"><span
                                            class="eye-open"></span></span>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="password"
                                        class="jvf form-control input-lg caps_check" id="password_confirmation"
                                        name="password_confirmation" placeholder="Confirm Password *" tabindex="7"
                                        maxlength="20">
                                    <span class="showpassword" id="password_confirmation_show"><span
                                            class="eye-open"></span></span>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" name="phone" id="phone"
                                        class="jvf form-control input-lg required customphone"
                                        placeholder="Mobile Phone Number *" tabindex="8"
                                        value="<?= addslashes($data['phone']) ?>">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" name="address"
                                        id="p_address" class="jvf form-control input-lg" placeholder="Street Address *"
                                        tabindex="9" value="<?= addslashes($data['address']) ?>"
                                        data-hintold="Enter a valid address.">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" name="address2"
                                        id="p_address2" class="jvf form-control input-lg"
                                        placeholder="Apartment, Suite, Unit, etc. (optional)" tabindex="10"
                                        value="<?= addslashes($data['address2']) ?>"
                                        data-hintold="Enter a valid address.">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" name="city" id="p_city"
                                        class="jvf form-control input-lg" placeholder="City *" tabindex="11"
                                        value="<?= addslashes($data['city']) ?>" data-hintold="Enter a valid city.">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <div class="form-group">
                                    <select data-hj-allow="true" name="state" id="p_state" preload="State" class=""
                                        placeholder="State *" title="State *" tabindex="12">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <div class="form-group">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" name="zipcode"
                                        id="p_zipcode" class="jvf form-control input-lg" placeholder="Zip Code *"
                                        tabindex="13" value="<?= addslashes($data['zipcode']) ?>"
                                        data-hintold="Enter a valid zipcode.">
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- <div class="form-group radio-group">
                            <div class="maxl">
                                <div class="form-row1">
                                    ...
                                    <div class="full-width align-left">
                                        <input data-hj-allow="true" type="hidden" data-f-count="2" data-fl_1="gender_m"
                                            data-fl_2="gender_f" class="patient-enroll-progress-2" data-step-enroll="2">
                                        <label for="gender_m" class='rb-container no_width'>Male
                                            <input data-hj-allow="true" autocomplete="nope" type="radio" tabindex="14"
                                                data-type="patient" id="gender_m" name="gender" value="M"
                                                <?= ($data['gender'] && $data['gender'] == 'M') ? 'checked' : '' ?>
                                                class="LoNotSensitive" preload="">
                                            <span class="rb-checkmark"></span>
                                        </label>
                                        <label for="gender_f" class='rb-container no_width'>Female
                                            <input data-hj-allow="true" autocomplete="nope" type="radio" tabindex="15"
                                                data-type="patient" id="gender_f" name="gender" value="F"
                                                <?= ($data['gender'] && $data['gender'] == 'F') ? 'checked' : '' ?>
                        ...
                        <!-- <div class="form-group radio-group">
                            <div class="maxl">
                                ...
                                <div class="full-width align-left">
                                    <input data-hj-allow="true" type="hidden" data-f-count="2" data-fl_1="is_minor_yes"
                                        data-fl_2="is_minor_no" class="patient-enroll-progress-2" data-step-enroll="2">
                                    <label for="is_minor_yes" class='rb-container no_width'>Yes
                                        <input data-hj-allow="true" onchange="changeIsMinor()" autocomplete="nope"
                                            type="radio" tabindex="16" data-type="patient" id="is_minor_yes"
                                            name="is_minor" value="1" <?= ($data['is_minor'] == '1') ? 'checked' : '' ?>
                                            class="LoNotSensitive "
                                    ...
                                    <label for="is_minor_no" class='rb-container no_width'>No
                                        <input data-hj-allow="true" onchange="changeIsMinor()" autocomplete="nope"
                                            type="radio" tabindex="17" data-type="patient" id="is_minor_no"
                                            name="is_minor" value="0" <?= ($data['is_minor'] == '0') ? 'checked' : '' ?>
                                            class="LoNotSensitive ">
                                        <span class="rb-checkmark"></span>
                                    </label>
                                </div>
                        ...
                        <div class="form-row1 patient_parent_profile no-show">
                            <!-- <div class="form-group">
                                <div class="full-width">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" tabindex="18"
                                        data-type="patient" id="p_parent_first_name" name="p_parent_first_name"
                                        value="<?php echo htmlspecialchars(stripslashes($data['parent_first_name'])); ?>"
                            ...
                            <div class="form-group">
                                <div class="full-width">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" tabindex="19"
                                        data-type="patient" id="p_parent_middle_initial" name="p_parent_middle_initial"
                                        value="<?php echo htmlspecialchars(stripslashes($data['parent_middle_initial'])); ?>"
                                        maxlength="1" class="LoNotSensitive"
                                        placeholder="Parent/Guardian Middle Initial"
                                        title="Parent/Guardian Middle Initials">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="full-width">
                                    <input data-hj-allow="true" autocomplete="nope" type="text" tabindex="20"
                                        data-type="patient" id="p_parent_last_name" name="p_parent_last_name"
                                        value="<?php echo htmlspecialchars(stripslashes($data['parent_last_name'])); ?>"
                            ...
                            <input data-hj-allow="true" autocomplete="nope" type="text" tabindex="21"
                                data-type="patient" id="p_parent_phone" name="p_parent_phone"
                                value="<?php echo $data['parent_phone']; ?>" class="LoNotSensitive customphone"
                                placeholder="Parent/Guardian Phone *" title="Parent/Guardian Phone *"> -->
                        </div>
                        <!-- <div class="form-group">
                            <div class="full-width"><input data-hj-allow="true" tabindex="22" autocomplete="nope"
                                    type="text" data-type="patient" name="alternate_contact_name"
                                    value="<?php echo htmlspecialchars(stripslashes($data['alternate_contact_name'])); ?>"
                                    class="LoNotSensitive" placeholder="Alternate Contact Name"
                                    title="Alternate Contact Name"></div>
                        </div>
                        <div class="form-group">
                            <div class="full-width"><input data-hj-allow="true" tabindex="23" autocomplete="nope"
                                    type="text" data-type="patient" name="alternate_phone"
                                    value="<?php echo $data['alternate_phone']; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="full-width">
                                <select data-hj-allow="true" data-type="patient" name="p_hear_about" tabindex="24"
                                    id="p_hear_about"
                                    ...
                                    <option value="Referral By Current Member of the Prescription Hope Program">Referral
                                        By Current Member of the Prescription Hope Program</option>
                        ...
                        <div class="checked-class">
                            <div class="condition">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label cb-container checkbox-label" for="register_terms">
                                        <input data-hj-allow="true" type="checkbox" tabindex="25"
                                            class="form-check-input checkbox-normal" id="register_terms"
                                            name="register_terms"><span class="cb-checkmark"></span>

                                        <span>By selecting this checkbox, you agree to receive important enrollment
                                            <br />information,
                                            updates, reminders, and promotional messages from Prescription<br /> Hope
                                            directly to your phone.
                                            Message frequency varies. Text <a target="_blank"
                                                href="https://prescriptionhope.com/privacy-policy/">HELP to 964673</a>
                                            for <br />help, <a target="_blank"
                                                href="https://prescriptionhope.com/terms-of-service/">STOP to 964673</a>
                                            to stop, Message and Data Rates May Apply.
                                            By opting<br /> in, you authorize Prescription Hope to deliver messages
                                            using an automatic <br />telephone dialing system, and you
                                            understand that you are not required to<br /> opt-in as a condition of
                                            purchasing any property, goods, or services. By leaving<br /> this checkbox
                                            unchecked, you will not opt-in for SMS messages at this time.</span>
                                    </label>
                            ...
                            <div class="condition">
                                <div class="form-check">
                                    <label class="form-check-label cb-container checkbox-label"
                                        for="ph_register_terms_email">
                                        <input data-hj-allow="true" type="checkbox" tabindex="26"
                                            class="form-check-input checkbox-normal" id="ph_register_terms_email"
                                            name="ph_register_terms_email"><span class="cb-checkmark"></span>
                                        <span>By selecting this checkbox, you understand and agree to Prescription
                                            Hope's <a target="_blank"
                                                href="https://prescriptionhope.com/privacy-policy/">privacy policy</a>
                                            and <a target="_blank"
                                                href="https://prescriptionhope.com/terms-of-service/">terms of
                                                service</a> Prescription Hope will send you emails with important
                                            enrollment information,
                                            updates, and reminders. You can unsubscribe at any time by clicking the link
                                            at the bottom of any Prescription Hope email.*</span> </label>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-xs-12">
                                <div id='recaptcha' class="g-recaptcha"
                                    data-sitekey="6LefboYUAAAAAJKoAxSTReZ4zKOQG91mGboDq_MS" data-callback="onSubmit"
                                    data-size="invisible"></div>
                                <input data-hj-allow="true" tabindex="27" type="button" name="register_submit"
                                    id="btSubmit" value="Submit"
                                    class="big-button loginPageButton btn btn-default bt btn-block btn-lg">
            ...
            <div id="owl-demo-mobile" class="owl-carousel owl-theme  bg-image-profile ">
                <div class="item">
                    <div class="testimonials col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h3>
                            <span class="t1"><img src="/enrollment/images/Account/testimonial-arrow.png"></span>
                            <span class="text-testimonials">When the rep from Prescription Hope called to tell me I was
                                qualified, I was speechless. They saved our home, they saved my health, they lifted that
                                enormous financial burden at a time when we needed it most.</span>
                            <p><span>- Theresa from Oregon</span></p>
                        </h3>
                    </div>
                </div>
                <div class="item">
                    <div class="testimonials col-lg-12 col-md-12 col-sm-12  col-xs-12">
                        <h3>
                            <span class="t1"><img src="/enrollment/images/Account/testimonial-arrow.png"></span>
                            <span class="text-testimonials">Prescription Hope has allowed me and my family to do several
                                other things because it has freed up funds from really expensive medication.</span>
                            <p><span>- Stephen from Iowa</span> </p>
                        </h3>
                    </div>
                </div>
                <div class="item">
                    <div class="testimonials col-lg-12 col-md-12 col-sm-12  col-xs-12">
                        <h3>
                            <span class="t1"><img src="/enrollment/images/Account/testimonial-arrow.png"></span>
                            <span class="text-testimonials">They were the most kind helpful people I have ever spoken
                                with. The experience has been life-changing.</span>
                            <p><span>- Mary From Indiana</span> </p>
                        </h3>
                    </div>
                </div>
...
<div class="container footer">
    <div class="col-sm-6 col-xs-12 safe-enroll pull-left">
        <div class="text-safe pull-left">
            <ul class="links">
                ...
                <li>
                    <p class="copy">2023 ©Prescription Hope, Inc.</p>
                </li>
            </ul>
        </div>
    </div>
    <div class="col-sm-6 col-xs-12 safe-enroll pull-right">
        <div class="text-safe pull-right">
            ...
            <div class="trustedsite_parent" style="    display: inline-block;
    position: relative;
    bottom: -16px;">
                <div class="trustedsite-trustmark loaded" data-type="202" data-width="120" data-height="50"
                    title="TrustedSite Certified" tabindex="0"
                    style="width: 120px; height: 50px; display: inline-block; background-image: url(&quot;https://cdn.ywxi.net/meter/prescriptionhope.com/202.svg?ts=1669685286876&amp;l=en-US&quot;); background-size: contain; background-position: center top; background-repeat: no-repeat; cursor: pointer;">
                </div>
            </div>
        </div>
    </div>
...
<div id="overlay_missing_email" class="overlay_content">
    <div class="overlay_loaded_content">
        <div class="overlay_form text-center">
            <p class="text-18 red">The email address entered does not match what we have on file for your account. In
                order to keep your information as safe as possible, please contact a patient advocate at 1-877-296-4673
                between 8:00am and 4:00pm Eastern Time.</p>
        </div>
...
jQuery(document).ready(function() {
    ...
    jQuery.validator.addMethod("custom_date", function(t, e) {
        return t = t.replace(/\s+/g, ""), td = t.split("/"), td = td[2] + "-" + td[0] + "-" + td[1],
            this.optional(e) || t.length > 8 && t.match(
                /^(0?[1-9]|1[012])[\/](0?[1-9]|[12][0-9]|3[01])[\/]\d{4}$/) && td <= new Date()
    ...
    formValidation = jQuery("#fmRegister").validate({
        ...
        highlight: function(element) {
            ...
            jQuery(element.form).find("label[for=label_for_" + element.id + "]").addClass(
                'has-error');
        },
        ...
        invalidHandler: function() {
            jQuery('#fmMsg').addClass('has-error').addClass('no-bold').html(
                'Please fill out correctly all the fields marked with red and then try again to submit the form.'
            );
        },
        onkeyup: false
    });
    ...
    jQuery('input[name="ph_register_terms_email"]').on('click', function() {
        if (jQuery('input[name="ph_register_terms_email"]').is(':checked')) {
            jQuery('input[name="ph_register_terms_email"]').parent().parent().removeClass(
                'checkbox-with-label-error');
            jQuery('input[name="ph_register_terms_email"]').parent().parent().addClass(
                'checkbox-with-label-correct');
        } else {
            jQuery('input[name="ph_register_terms_email"]').parent().parent().removeClass(
                'checkbox-with-label-correct');
            jQuery('input[name="ph_register_terms_email"]').parent().parent().addClass(
    ...
    jQuery('input[name="ph_register_terms_email"]').attr('checked',
        <?= !(bool) $data['ph_register_terms_email'] ?>);
    ...
    jQuery('.open_video').click(function() {
        jQuery('#video_holder').html(
            '<div class="iframe-wrapper"><iframe src="https://www.youtube.com/embed/' + jQuery(this)
            .attr('data-href') +
            '?rel=0&showinfo=0&autoplay=1" frameborder="0" allowfullscreen></iframe></div>');
        jQuery('#video_info').html('<p>Prescription Hope Story: ' + jQuery(this).attr('data-name') +
            ' </p>');
...
jQuery("input[name='alternate_phone']").mask("000-000-0000", {
    clearIfNotMatch: true
});
...
if (jQuery('#p_hear_about').is("select") && (jQuery('#p_hear_about').val() != '' || jQuery('#p_hear_about').data(
        'value') != '')) {
