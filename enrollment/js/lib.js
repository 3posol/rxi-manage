...
//    debugger;
    if(jQuery('input[name="p_has_income"]:checked').val() == 1 || jQuery('input[name="p_has_income"]:checked').val() == 0){
        jQuery('.patient_income_yes_only_div').removeClass('hidden');
    }else{
        jQuery('.patient_income_yes_only_div').addClass('hidden');
    }
