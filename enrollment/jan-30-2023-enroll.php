                    ...
                    <script type="text/javascript">
                        ...
                        jQuery(document).ready(function () {
                            ...
                            jQuery.validator.addMethod("custom_date", function (t, e) {
                                return t = t.replace(/\s+/g, ""), td = t.split("/"), td = td[2] + "-" + td[0] + "-" + td[1], this.optional(e) || t.length > 8 && t.match(/^(0?[1-9]|1[012])[\/](0?[1-9]|[12][0-9]|3[01])[\/]\d{4}$/) && td <= new Date().toISOString().substring(0, 10)
                                    ...
                                    jQuery.validator.addMethod("SSN", function (t, e) {
                                        return t = t.replace(/\s+/g, ""), this.optional(e) || t.length > 8 && t.match(/^\d{3}-?\d{2}-?\d{4}$/)
                            ...
                            jQuery.validator.addMethod("valid_exp_date", function (value, element) {
                                return ("20" + value.substr(3, 2) + value.substr(0, 2)) > <?= date('Ym') ?> && parseInt(value.substr(0, 2)) > 0 && parseInt(value.substr(0, 2)) <= 12;
                            ...
                            form_validator = jQuery("#register_form").validate({
                                rules: {
                                    ...
                                    p_income_file_tax_return: {required: true},
                                    ...
                                    p_cc_number: {required: jQuery("#p_payment_method_cc"), number: true},
                                    p_cc_address: {required: true, ascii: true},
                                    p_cc_city: {required: true, ascii: true},
                                    p_cc_name: {required: true},
                                    p_cc_state: {required: true},
                                    p_cc_zip: {required: true, digits: true, minlength: 5, maxlength: 5},
                            ...
                            jQuery("input[name='p_medicare'], input[name=p_medicaid], input[name=p_lis], input[name=p_medicare_part_d], input[name=p_coveragegapyes]").change(function (e) {
                                                ...
                                                .done(function (response) {
                                                    ...
                                                    if (result.success == 0) {
                                                        ...
                                                        if (jQuery("form#register_form").valid() && hasDoctors && hasMeds && !medsWithErrors) {
                                                            ...
                                                            if (!hasDoctors) {
                                                                jQuery(".dr-form").eq(0).before("<label class='error' style='width: auto !important; padding: 0; font-size: 16px;'>Please add at least one Healthcare Provider(s).<br><br></label>");
                                ...
                                jQuery(this).autocomplete({
                                    ...
                                    source: function (request, response) {
                                        jQuery.ajax({
                                            ...
                                            success: function (data) {
                                                response($.map(data.meds, function (item) {
                                                    //console.log(item);
                                                    return {
                                                        ApplNo: item.ApplNo,
                                    ...
                                    select: function (event, ui) {
                                        ...
                                        jQuery(event.target).closest('.form-group').next().find('input').val(ui.item.Strength).trigger('change');
                                        ...
                                        .autocomplete("instance")._renderItem = function (ul, item) {
                                    return jQuery("<li>")
                                            .append("<div>" + item.DrugName +" ("+item.Strength+")" + "</div>")
                                            .appendTo(ul);
                                };
                            });
                    ...
                    <div class="container">
                        <div class="col-sm-12 p0">
                            ...
                            <?php /* <form id="register_form" method="post" action="enroll.php" autocomplete="nope">
                              ...
                              <div>
                              <div class="third-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_first_name" value="<?php echo htmlspecialchars(stripslashes($data['p_first_name']));?>" class="LoNotSensitive <?=(($data['p_first_name'] != '') ? 'correct' : '')?>" placeholder="First Name *"></div>
                              <div class="third-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_middle_initial" value="<?php echo htmlspecialchars(stripslashes($data['p_middle_initial']));?>" maxlength="1" class="LoNotSensitive <?=(($data['p_middle_initial'] != '') ? 'correct' : '')?>" placeholder="Middle Initial"></div>
                              <div class="third-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_last_name" value="<?php echo htmlspecialchars(stripslashes($data['p_last_name']));?>" class="LoNotSensitive <?=(($data['p_last_name'] != '') ? 'correct' : '')?>" placeholder="Last Name *"></div>
                              </div>
                              <div class="clear"></div>


                              <div>
                              <div class="half-width m-v-10"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" id="p_dob" name="p_dob" value="<?php echo $data['p_dob'];?>" class="LoNotSensitive tooltiptext" placeholder="Date of Birth (mm/dd/yyyy) *" data-text="Why Is My Date Of Birth Needed?" data-hint="Your Date of Birth is required by the pharmaceutical company to process your medication orders."></div>
                              <?php if(isset($response->success) && $response->success==2){ ?>
                              <div class="half-width m-v-10"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_ssn" value="<?php echo $_POST['p_ssn'];?>" maxlength="11" class="LoNotSensitive tooltiptext" placeholder="Social Security Number *" data-text="Why Is My Social Security Number Needed?" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology."></div>
                              <?php } else { ?>
                              <div class="half-width m-v-10"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_ssn" value="<?php echo $data['p_ssn'];?>" maxlength="11" class="LoNotSensitive tooltiptext" placeholder="Social Security Number *" data-text="Why Is My Social Security Number Needed?" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology."></div>
                              <?php } ?>
                              </div>
                              <div class="clear"></div>
                              ...
                              <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_gender_m" name="p_gender" value="M" class="LoNotSensitive" preload="<?php echo $data['p_gender'];?>">
                              <span class="rb-checkmark"></span>
                              </label>
                              <label for="p_gender_f" class='rb-container no_width'>Female
                              <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_gender_f" name="p_gender" value="F" class="LoNotSensitive">
                              <span class="rb-checkmark"></span>
                              </label>
                              </div>
                              </div>
                              ...
                              <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_is_minor_yes" name="p_is_minor" value="1" class="LoNotSensitive" <?php echo ((in_array('is_minor', $radios_submitted) && $data['p_is_minor'] != '') ? 'preload="' . (int)$data['p_is_minor'] . '"' : ''); ?>>
                              <span class="rb-checkmark"></span>
                              </label>
                              <label for="p_is_minor_no" class='rb-container no_width'>No
                              <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_is_minor_no" name="p_is_minor" value="0" class="LoNotSensitive">
                              <span class="rb-checkmark"></span>
                              </label>
                              </div>
                              </div>
                              ...
                              <div>
                              <div class="third-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_parent_first_name" value="<?php echo htmlspecialchars(stripslashes($data['p_parent_first_name']));?>" class="LoNotSensitive" placeholder="Parent/Guardian First Name *"></div>
                              <div class="third-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_parent_middle_initial" value="<?php echo htmlspecialchars(stripslashes($data['p_parent_middle_initial']));?>" maxlength="1" class="LoNotSensitive" placeholder="Parent/Guardian Middle Initial *"></div>
                              <div class="third-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_parent_last_name" value="<?php echo htmlspecialchars(stripslashes($data['p_parent_last_name']));?>" class="LoNotSensitive" placeholder="Parent/Guardian Last Name *"></div>
                              </div>
                              <div class="clear"></div>

                              <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_parent_phone" value="<?php echo $data['p_parent_phone'];?>" class="LoNotSensitive" placeholder="Parent/Guardian Phone *">
                              </div>
                              <div class="clear"></div>
                              <?php */ ?>
                            <!-- <div>
                            ...
                            <?php if (isset($_SESSION['register_data']['p_application_source']) && trim($_SESSION['register_data']['p_application_source']) != '') { ?>
                                ...
                                if (count($broker_array) == 2) {
                                    ?>
                                    <?php /*  <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_hear_about" value="<?php echo htmlspecialchars(stripslashes(trim(substr($data['p_application_source'],9))));?>" class="full-width" <?=((isset($_SESSION['register_data']['p_application_source']) && trim($_SESSION['register_data']['p_application_source']) != '') ? 'readonly="readonly"' : '')?>> */ ?>
                                    <?php
                                } else {
                                    ?>	
                                    <?php /* <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_hear_about" value="<?php echo htmlspecialchars(stripslashes($data['p_hear_about']));?>" class="full-width" <?=((isset($_SESSION['register_data']['p_application_source']) && trim($_SESSION['register_data']['p_application_source']) != '') ? 'readonly="readonly"' : '')?>> */ ?>
                                <?php } ?>
                            ...
                            <?php } else { ?>
                                <div class="full-width">
                                    ...
                                    <?php if (!empty($data['p_application_source']) && count($broker_array) == 2) { ?>
                                        ...
                                        <?php /* <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_hear_about" value="<?php echo htmlspecialchars(stripslashes(trim(substr($data['p_application_source'],9))));?>" class="full-width" <?=((isset($_SESSION['register_data']['p_application_source']) && trim($_SESSION['register_data']['p_application_source']) != '') ? 'readonly="readonly"' : '')?>> */ ?>
                                    <?php } else { ?>
                                        <?php /* <select data-hj-allow="true" data-type="patient" name="p_hear_about" id="p_hear_about" data-value="<?php echo htmlspecialchars(stripslashes($data['p_hear_about']));?>" class="full-width LoNotSensitive form-control" placeholder="How did you hear about Prescription Hope? *">
                            ...
                            <?php /* <div class="">
                              ...
                              <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_has_income_no" name="p_has_income" value="0" class="LoNotSensitive">
                              <span class="rb-checkmark"></span>
                              </label>
                              </div>
                              </div>
                            ...
                            <?php /* <div class="">
                              ...
                              <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_income_file_tax_return_no" name="p_income_file_tax_return" value="0" class="LoNotSensitive">
                              <span class="rb-checkmark"></span>
                              </label>
                              </div>
                              <br>
                            ...
                            <?php /* <div old-id="new_doctor_form" id="doctors_forms_list">
                              ...
                              <div class="half-width doctor-fname-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_first_name[<?=$valid_drs?>]" value="<?=$doctor['doctor_first_name']?>" class="doctor_first_name-<?=$valid_drs?> dr-required dr-data doctor-fields LoNotSensitive" placeholder="Healthcare Provider First Name *"></div>
                              <div class="half-width doctor-lname-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_last_name[<?=$valid_drs?>]" value="<?=$doctor['doctor_last_name']?>" class="doctor_last_name-<?=$valid_drs?> dr-required dr-data doctor-lname-fields LoNotSensitive" placeholder="Healthcare Provider Last Name *"></div>
                              </div>

                              <div>
                              <div class="half-width doctor-facility-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_facility[<?=$valid_drs?>]" value="<?=$doctor['doctor_facility']?>" class="doctor_facility-<?=$valid_drs?> dr-data LoNotSensitive" placeholder="Facility Name"></div>
                              <div class="half-width doctor-address-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_address[<?=$valid_drs?>]" value="<?=$doctor['doctor_address']?>" class="doctor_address-<?=$valid_drs?> dr-required dr-data dr-address LoNotSensitive" placeholder="Address *" rel="Some health care providers have multiple locations they work from, please provide the address for the location you visit your health care provider at."></div>
                              </div>

                              <div>
                              <div class="half-width doctor-address2-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_address2[<?=$valid_drs?>]" value="<?=$doctor['doctor_address2']?>" class="doctor_address2-<?=$valid_drs?> dr-data LoNotSensitive" placeholder="Suite Number"></div>
                              <div class="half-width doctor-city-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_city[<?=$valid_drs?>]" value="<?=$doctor['doctor_city']?>" class="doctor_city-<?=$valid_drs?> dr-required dr-data LoNotSensitive" placeholder="City *"></div>
                              </div>

                              <div>
                              <div class="half-width doctor-state-field">
                              <select data-hj-allow="true" name="doctor_state[<?=$valid_drs?>]" id="doctor_state[<?=$valid_drs?>]" preload="<?=$doctor['doctor_state']?>" class="doctor_state-<?=$valid_drs?> dr-required dr-data full-width LoNotSensitive" placeholder="State *">
                              ...
                              <div class="half-width doctor-zip-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_zip[<?=$valid_drs?>]" value="<?=$doctor['doctor_zip']?>" maxlength="5" class="doctor_zip-<?=$valid_drs?> dr-required dr-data dr-zip LoNotSensitive" placeholder="Zip Code *"></div>
                              </div>

                              <div>
                              <div class="half-width doctor-phone-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_phone[<?=$valid_drs?>]" value="<?=$doctor['doctor_phone']?>" class="doctor_phone-<?=$valid_drs?> dr-required dr-data dr-phone LoNotSensitive" placeholder="Phone Number *"></div>
                              <div class="half-width doctor-fax-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_fax[<?=$valid_drs?>]" value="<?=$doctor['doctor_fax']?>" class="doctor_fax-<?=$valid_drs?> dr-data dr-fax LoNotSensitive" placeholder="Fax Number"></div>
                              </div>
                              </div>
                              <?php } ?>
                              <?php } ?>
                              ...
                              <div><input data-hj-allow="true" autocomplete="nope" type="button" name="bAddANewDoctor" id="bAddANewDoctor" value="Add Another Provider" class="cancel small-button-orange button-auto-width"></div>
                              <div class="form-group-spacer"></div> */ ?>
                            ...
                            <?php /* if ($valid_meds == 0) { >
                              ...
                              <div>
                              <div class="medication-name-field half-width">
                              <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_name[1]" value="" placeholder="Medication Name *" class="med-data LoNotSensitive med_name">
                              </div>
                              <div class="medication-strength-field half-width">
                              <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_strength[1]" value="" placeholder="Medication Strength *" class="med-data LoNotSensitive">
                              </div>
                              </div>
                              <div>
                              <div class="medication-frequency-field half-width">
                              <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_frequency[1]" value="" placeholder="Medication Frequency (ex. daily) *" class="med-data LoNotSensitive">
                              </div>
                              <div class="medication-doctor-field half-width">
                              <select data-hj-allow="true" autocomplete="nope" name="medication_doctor[1]" class="doctors_dropdown med-data full-width LoNotSensitive" placeholder="Prescribing Healthcare Provider *">
                              <option value="">Prescribing Healthcare Provider *</option>
                              <?php /*foreach ($data['doctors'] as $dr_key => $doctor) { ?>
                            ...
                            <div class="pay-info">
                                ...
                                <?php if (!(isset($agent_details['use_payment']) && (bool) $agent_details['use_payment'])) { /* ?>
                                  ...
                                  <div class="p-gatway ">
                                  <input data-hj-allow="true" autocomplete="nope" type="hidden" data-type="patient" id="p_payment_method_cc" name="p_payment_method" value="cc">
                                  ...
                                  <input data-hj-allow="true" autocomplete="nope" type="hidden" name="p_cc_type" value="<?php echo $data['p_cc_type'];?>">
                                  <div class="full-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_cc_number" value="<?php echo $data['p_cc_number'];?>" placeholder="Credit Card Number *" class="" maxlength="16"></div>
                                  </div>
                                  <div>

                                  <div class="half-width">
                                  <input data-hj-allow="true" autocomplete="nope" type="hidden" name="p_cc_exp_month" value="<?php echo $data['p_cc_exp_month'];?>">
                                  <input data-hj-allow="true" autocomplete="nope" type="hidden" name="p_cc_exp_year" value="<?php echo $data['p_cc_exp_year'];?>">
                                  <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_cc_exp_date" value="<?=($data['p_cc_exp_month']!='' && $data['p_cc_exp_month']!='') ? $data['p_cc_exp_month'] . '/' . substr($data['p_cc_exp_year'], 2, 2) : ''?>" maxlength="5" class="" placeholder="MM/YY *">
                                  ...
                                  <div class="half-width">
                                  <input data-hj-allow="true" autocomplete="nope" type="password" data-type="patient" name="p_cc_cvv" value="<?php echo $data['p_cc_cvv'];?>" maxlength="4" placeholder="CVC *" class="">
                                  ...
                                  <p>
                                  <input data-hj-allow="true" autocomplete="nope" type="checkbox" id="p_acknowledge_agreement"  name="p_acknowledge_agreement" value="1" <?php echo (($data['p_acknowledge_agreement'] == 1) ? 'checked="checked"' : ''); ?>>&nbsp;&nbsp;
        ...
        jQuery(document).ready(function () {
            ...
            jQuery(document).on('click tap', '.remove_block', function () {
                ...
                if (block_id.indexOf("mb") != -1) {
                    ...
                    jQuery('.total_str').html('$' + (jQuery("#settings-r .cg_medication_form").length) * med_price + '.00');
...
<?php } ?>
    ...
    <?php /* <div  class="col-sm-12 row">
      ...
      <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_address" id="p_address" value="<?php echo htmlspecialchars(stripslashes($data['p_address']));?>" class="LoNotSensitive" placeholder="Street Address *">
      ...
      <div class="form-group">
      <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_address2" value="<?php echo htmlspecialchars(stripslashes($data['p_address2']));?>" class="LoNotSensitive" placeholder="Apartment, Suite, Unit, etc.">
      ...
      <div class="form-group">
      <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_city" value="<?php echo htmlspecialchars(stripslashes($data['p_city']));?>" class="LoNotSensitive form-control" placeholder="City *">
      </div>
      </div>
      <div class="col-sm-4 w-100">
      <div class="form-group">
      <select data-hj-allow="true" data-type="patient" name="p_state" id="p_state" preload="<?php echo $data['p_state'];?>" class="form-control full-width LoNotSensitive" placeholder="State *">
      ...
      <div class="form-group">
      <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_zip" value="<?php echo $data['p_zip'];?>" maxlength="5" class="LoNotSensitive form-control" placeholder="ZIP Code *">
      </div>
      </div>
      ...
      <div class="form-group">
      <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" id="p_dob" aria-describedby="date" name="p_dob" value="<?php echo $data['p_dob'];?>" class="LoNotSensitive tooltiptext form-control" placeholder="Date of Birth (mm/dd/yyyy) *" data-text="Why Is My Date Of Birth Needed?" data-hint="Your Date of Birth is required by the pharmaceutical company to process your medication orders.">
      ...
      <div class="form-group">
      <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_alternate_contact_name" value="<?php echo htmlspecialchars(stripslashes($data['p_alternate_contact_name']));?>" class="LoNotSensitive form-control" placeholder="Alternate Contact Name">
      </div>
      </div>
      <div class="col-sm-6 w-100 p-r-0">
      <div class="form-group">
      <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_alternate_phone" value="<?php echo $data['p_alternate_phone'];?>" class="LoNotSensitive not_required_phone form-control" placeholder="Alternate Contact Phone">
      </div>
      </div>
      <div class="form-group">
      <?php if(!empty($data['p_application_source']) && count($broker_array) == 2){?>
      ...
      <input data-hj-allow="true" class="form-control" autocomplete="nope" type="text" data-type="patient" name="p_hear_about" value="<?php echo htmlspecialchars(stripslashes(trim(substr($data['p_application_source'],9))));?>" class="full-width" <?=((isset($_SESSION['register_data']['p_application_source']) && trim($_SESSION['register_data']['p_application_source']) != '') ? 'readonly="readonly"' : '')?>>
      <?php }else{?>
      <select data-hj-allow="true" class="form-control" data-type="patient" name="p_hear_about" id="p_hear_about" data-value="<?php echo htmlspecialchars(stripslashes($data['p_hear_about']));?>" class="full-width LoNotSensitive form-control" placeholder="How did you hear about Prescription Hope? *">
      <option value="">How did you hear about Prescription Hope? *</option>
      <option value="Facebook">Facebook</option>
      <option value="Instagram">Instagram</option>
      <option value="Internet">Internet</option>
      ...
      <select data-hj-allow="true" data-type="patient" name="p_married" id="p_married" preload="<?php echo $data['p_married'];?>" class="form-control">
      <option value=''>Select ...</option>
      <option value='S'>Single</option>
      <option value='M'>Married</option>
      <option value='D'>Separated</option>
      ...
      <div>
      <input data-hj-allow="true" autocomplete="nope" type="button" name="bAddANewDoctor" id="bAddANewDoctor" value="Add Another Provider" class="cancel small-button-orange button-auto-width">
      </div>
      </div>
    ...
    <div  class="col-sm-12 row d-flex menu-sidebar" id="wrapper">
        ...
        <div class="col-xs-3 sidebar-tabs bg-light border-right" id="sidebar-wrapper">
            ...
            <ul class="nav nav-tabs tabs-left sideways" id="enroll-progress">
                ...
                <li class="clickable <?php echo ($step == 1) ? 'active' : '' ?> <?php echo ($step > 1) ? "completed" : '' ?>" id="patient-enroll-progress_1" data-step-enroll="1">
                ...
                <li class="clickable <?php echo ($step == 2 || $step == 3) ? 'active' : '' ?> <?php echo ($step > 2) ? "completed" : '' ?>" id="patient-enroll-progress_2" data-step-enroll="2">
                ...
                <li class="clickable <?php echo ($step == 4) ? 'active' : '' ?> <?php echo ($step > 4) ? "completed" : '' ?>" id="patient-enroll-progress_4" data-step-enroll="4">
                ...
                <li class="clickable <?php echo ($step == 5) ? 'active' : '' ?> <?php echo ($step > 5) ? "completed" : '' ?>" id="patient-enroll-progress_6" data-step-enroll="6">
                ...
                <li class="final-submit-li">
                    <button class="btn btn-primary" id="final-submit" type="button" data-final-submit="1" data-step-enroll="6" style="display:none;">Submit</button>
                </li>
            </ul>
            <!-- </div>  -->
        </div>
                                ...
                                <div>
                                    <div class="form-group">		
                                        <div class="medication-name-field full-width">
                                            <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_name[1]" value="" placeholder="Medication Name *" title="Medication Name *" class="dyn med-data LoNotSensitive med_name patient-enroll-progress-5 clear_vals" data-step-enroll="5">
                                        </div>
                                    </div>
                                    <div class="form-group">			
                                        <div class="medication-strength-field full-width">
                                            <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_strength[1]" value="" placeholder="Medication Strength *" title="Medication Strength *" class="dyn med-data LoNotSensitive patient-enroll-progress-5 clear_vals" data-step-enroll="5">
                                        </div>
                                    </div>	
                                </div>
                                <div>
                                    <div class="form-group">		
                                        <div class="medication-frequency-field full-width">
                                            <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_frequency[1]" value="" placeholder="Medication Frequency (ex. daily) *" title="Medication Frequency (ex. daily) *" class="dyn med-data LoNotSensitive patient-enroll-progress-5 clear_vals" data-step-enroll="5">
                                        </div>
                                    </div>
                                    <input data-hj-allow="true" type="hidden" autocomplete="nope" name="medication_doctor[1]" class="cg_medication_doctor med-data full-width LoNotSensitive patient-enroll-progress-5">
                                </div>
                ...
                <div class="tab-content">
                            ...
                            <div class="col-sm-7 card-form">
                                ...
                                <div>
                                    <div class="full-width form-group">
                                        <input data-hj-allow="true" type="hidden" name="p_phone" value="<?php echo $data['p_phone']; ?>">
                                        <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_address" id="p_address" value="<?php echo htmlspecialchars(stripslashes($data['p_address'])); ?>" class="LoNotSensitive patient-enroll-progress-1" placeholder="Street Address *" title="Street Address *" data-step-enroll="1">
                                    ...
                                    <div class="full-width form-group"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_address2" value="<?php echo htmlspecialchars(stripslashes($data['p_address2'])); ?>" class="LoNotSensitive" placeholder="Apartment, Suite, Unit, etc." title="Apartment, Suite, Unit, etc.">
                                    </div>
                                </div>
                                <div class="clear"></div>

                                <div>
                                    <div class="third-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_city" value="<?php echo htmlspecialchars(stripslashes($data['p_city'])); ?>" class="LoNotSensitive patient-enroll-progress-1" placeholder="City *" title="City *" data-step-enroll="1">
                                    </div>
                                    <div class="third-width">							
                                        <select data-hj-allow="true" data-type="patient" name="p_state" id="p_state" preload="<?php echo $data['p_state']; ?>" class="form-control full-width LoNotSensitive patient-enroll-progress-1" placeholder="State *" title="State *" data-step-enroll="1">
                                            <option value=""></option>
                                            <option value="AL">Alabama</option>
                                            <option value="AK">Alaska</option>
                                            <option value="AZ">Arizona</option>
                                    ...
                                    <div class="third-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_zip" value="<?php echo $data['p_zip']; ?>" maxlength="5" class="LoNotSensitive patient-enroll-progress-1" placeholder="ZIP Code *" title="ZIP Code *" data-step-enroll="1"></div>
                            ...
                            <div class="col-sm-7 card-form">
                                ...
                                <div class="form-group radio-group">
                                    <div class="maxl">
                                        ...
                                        <div class="full-width align-left">
                                            <input data-hj-allow="true" type="hidden" data-f-count="2" data-fl_1="p_is_minor_yes" data-fl_2="p_is_minor_no" class="patient-enroll-progress-2" data-step-enroll="2">
                                            <label for="p_is_minor_yes" class='rb-container no_width'>Yes
                                                <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_is_minor_yes" name="p_is_minor" value="1" class="LoNotSensitive " <?php echo ((in_array('is_minor', $radios_submitted) && $data['p_is_minor'] != '') ? 'preload="' . (int) $data['p_is_minor'] . '"' : ''); ?> >
                                                <span class="rb-checkmark"></span>
                                            </label>
                                ...
                                <div class="form-row1 patient_parent_profile no-show">
                                    <div class="form-group">
                                        <div class="full-width">
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_parent_first_name" value="<?php echo htmlspecialchars(stripslashes($data['p_parent_first_name'])); ?>" class="LoNotSensitive" placeholder="Parent/Guardian First Name *" title="Parent/Guardian First Name *">
                                        </div>
                                    </div>	
                                    <div class="form-group">	
                                        <div class="full-width">
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_parent_middle_initial" value="<?php echo htmlspecialchars(stripslashes($data['p_parent_middle_initial'])); ?>" maxlength="1" class="LoNotSensitive" placeholder="Parent/Guardian Middle Initial *" title="Parent/Guardian Middle Initial *">
                                        </div>
                                    </div>
                                    <div class="form-group">	
                                        <div class="full-width">
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_parent_last_name" value="<?php echo htmlspecialchars(stripslashes($data['p_parent_last_name'])); ?>" class="LoNotSensitive" placeholder="Parent/Guardian Last Name *" title="Parent/Guardian Last Name *">
                                        </div>
                                    </div>
                                    <div class="clear"></div>

                                    <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_parent_phone" value="<?php echo $data['p_parent_phone']; ?>" class="LoNotSensitive" placeholder="Parent/Guardian Phone *" title="Parent/Guardian Phone *">
                                </div>
                                <div class="clear"></div>
                                ...
                                <div class="form-group radio-group">
                                    <div class="maxl">
                                        <div class="form-row1">
                                            ...
                                            <div class="full-width align-left">
                                                <input data-hj-allow="true" type="hidden" data-f-count="2" data-fl_1="p_gender_m" data-fl_2="p_gender_f" class="patient-enroll-progress-2" data-step-enroll="2">
                                                <label for="p_gender_m" class='rb-container no_width'>Male
                                                    <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_gender_m" name="p_gender" value="M" class="LoNotSensitive" preload="<?php echo $data['p_gender']; ?>" >
                                                    <span class="rb-checkmark"></span>
                                                </label>
                                ...
                                <div class="form-group">
                                    <div class="full-width">
                                        <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" id="p_dob" name="p_dob" value="<?php echo $data['p_dob']; ?>" class="LoNotSensitive patient-enroll-progress-2" placeholder="Date of Birth (mm/dd/yyyy) *" title="Date of Birth (mm/dd/yyyy) *" data-text="Why Is My Date Of Birth Needed?" data-hint="" data-step-enroll="2">
                                        <p class="tooltip-text" href="javascript:void(0);" data-toggle="tooltip">Your Date of Birth is required by the pharmaceutical company to process your medication orders.</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <?php if (isset($response->success) && $response->success == 2) { ?>
                                        <div class="full-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_ssn" value="<?php echo $_POST['p_ssn']; ?>" maxlength="11" class="patient-enroll-progress-2 LoNotSensitive" placeholder="Social Security Number *" title="Social Security Number *" data-text="" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology." data-step-enroll="2">
                                            <a class="tooltip-text first" href="javascript:void(0);" data-toggle="tooltip" title="" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology. We take the security of your personal information very seriously.">Your social security number is required by the pharmaceutical company to process your medication order.</a>		
                                            <a class="tooltip-text third" href="javascript:void(0);" data-toggle="tooltip" title="" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology. We take the security of your personal information very seriously.">We take the security of your personal information very seriously.</a>	
                                            <a class="tooltip-text second" href="javascript:void(0);" data-toggle="tooltip" title="" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology. We take the security of your personal information very seriously.">Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology.</a>
                                        </div>
                                    <?php } else { ?>
                                        <div class="full-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_ssn" value="<?php echo $data['p_ssn']; ?>" maxlength="11" class="patient-enroll-progress-2 LoNotSensitive" placeholder="Social Security Number *" title="Social Security Number *" data-text="" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology." data-step-enroll="2">
                                            <a class="tooltip-text first" href="javascript:void(0);" data-toggle="tooltip" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology. We take the security of your personal information very seriously.">Your social security number is required by the pharmaceutical company to process your medication order.</a>		
                                            <a class="tooltip-text third" href="javascript:void(0);" data-toggle="tooltip" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology. We take the security of your personal information very seriously.">We take the security of your personal information very seriously.</a>	
                                            <a class="tooltip-text second" href="javascript:void(0);" data-toggle="tooltip" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology. We take the security of your personal information very seriously.">Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology.</a>
                                        </div>
                                    <?php } ?>
                                ...
                                <!-- <div class="col-sm-6 w-100 p-l-0"> -->
                                <div class="form-group">
                                    <div class="full-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_alternate_contact_name" value="<?php echo htmlspecialchars(stripslashes($data['p_alternate_contact_name'])); ?>" class="LoNotSensitive" placeholder="Alternate Contact Name" title="Alternate Contact Name"></div>
                                </div>
                                <!-- </div>
                                <div class="col-sm-6 w-100 p-r-0"> -->
                                <div class="form-group">
                                    <div class="full-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_alternate_phone" value="<?php echo $data['p_alternate_phone']; ?>" class="LoNotSensitive not_required_phone" placeholder="Alternate Contact Phone" title="Alternate Contact Phone"></div>
                                </div>
                                <!-- </div> -->
                                <div class="form-group">
                                    <?php //echo "<pre>";print_r($_SESSION['register_data']);echo "</pre>";   ?>
                                    ...
                                    <?php if (isset($_SESSION['register_data']['p_application_source']) && trim($_SESSION['register_data']['p_application_source']) != '') { ?>
                                        ...
                                        if (count($broker_array) == 2) {
                                            ?>
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_hear_about" value="<?php echo htmlspecialchars(stripslashes(trim(substr($data['p_application_source'], 9)))); ?>" class="full-width" <?= ((isset($_SESSION['register_data']['p_application_source']) && trim($_SESSION['register_data']['p_application_source']) != '') ? 'readonly="readonly"' : '') ?>>
                                            <?php
                                        } else {
                                            ?>	
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_hear_about" value="<?php echo htmlspecialchars(stripslashes($data['p_hear_about'])); ?>" class="full-width" <?= ((isset($_SESSION['register_data']['p_application_source']) && trim($_SESSION['register_data']['p_application_source']) != '') ? 'readonly="readonly"' : '') ?>>
                                        <?php } ?>
                        ...
                        <div class="tab-1">
                            <div class="col-sm-5">
                                <div class="heading-title">
                                    ...
                                    <p>The pharmaceutical manufacturers require <span class="this">this</span> information to process your medication orders. All of your information will be kept confidential and protected.</p>
                                </div>
                            </div>
                            <div class="col-sm-7 card-form">
                                <!-- <form> -->
                                ...
                                <div class="form-group">
                                    <div class="full-width">
                                        <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" id="p_dob" name="p_dob" value="<?php echo $data['p_dob']; ?>" class="LoNotSensitive patient-enroll-progress-2" placeholder="Date of Birth (mm/dd/yyyy) *" title="Date of Birth (mm/dd/yyyy) *" data-text="Why Is My Date Of Birth Needed?" data-hint="" data-step-enroll="2">
                                        <p class="cb_text_description" href="javascript:void(0);" data-toggle="tooltip" >Your Date of Birth is required by the pharmaceutical company to process your medication orders.</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <?php if (isset($response->success) && $response->success == 2) { ?>
                                        <div class="full-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_ssn" value="<?php echo $_POST['p_ssn']; ?>" maxlength="11" class="patient-enroll-progress-2 LoNotSensitive" placeholder="Social Security Number *" title="Social Security Number *" data-text="" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology." data-step-enroll="2">
                                            <p class="cb_text_description first" href="javascript:void(0);" data-toggle="tooltip" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology. We take the security of your personal information very seriously.">Your social security number is required by the pharmaceutical company to process your medication order.</p>		
                                            <p class="cb_text_description third" href="javascript:void(0);" data-toggle="tooltip" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology. We take the security of your personal information very seriously.">We take the security of your personal information very seriously.</p>	
                                            <p class="cb_text_description second" href="javascript:void(0);" data-toggle="tooltip" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology. We take the security of your personal information very seriously.">Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology.</p>
                                        </div>
                                    <?php } else { ?>
                                        <div class="full-width"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_ssn" value="<?php echo $data['p_ssn']; ?>" maxlength="11" class="patient-enroll-progress-2 LoNotSensitive" placeholder="Social Security Number *" title="Social Security Number *" data-text="" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology." data-step-enroll="2">
                                            <p class="cb_text_description first" href="javascript:void(0);" data-toggle="tooltip" data-hint="Your social security number is required by the pharmaceutical company to process your medication order. Information relating to electronic transactions entered into this website will be protected by 256-bit encryption technology. We take the security of your personal information very seriously.">Your social security number is required by the pharmaceutical company to process your medication order.</p>	
                        ...
                        <div class="tab-1">
                            ...
                            <div class="col-sm-7 card-form">
                                <div class="radio-group">
                                    ...
                                    <div class="full-width align-left">
                                        <input data-hj-allow="true" type="hidden" data-f-count="2" data-fl_1="p_has_income_yes" data-fl_2="p_has_income_no" class="patient-enroll-progress-3" data-step-enroll="3">
                                        <label for="p_has_income_yes" class='rb-container no_width'>Yes
                                            <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_has_income_yes" name="p_has_income" value="1" class="LoNotSensitive patient-enroll-progress-3" <?php echo ((in_array('has_income', $radios_submitted) && $data['p_has_income'] != '') ? 'preload="' . (int) $data['p_has_income'] . '"' : ''); ?> data-step-enroll="3">
                                            <span class="rb-checkmark"></span>
                                        </label>
                                        <label for="p_has_income_no" class='rb-container no_width'>No
                                            <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_has_income_no" name="p_has_income" value="0" class="LoNotSensitive patient-enroll-progress-3" data-step-enroll="3">
                                            <span class="rb-checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="radio-group">
                                    <div class="full-width align-left">
                                        <label for="p_income_file_tax_return">Do you file taxes? <span class="red">*</span></label>
                                    </div>
                                    <div class="full-width align-left addStarValidation">
                                        <label for="p_income_file_tax_return_yes" class='rb-container no_width'>Yes
                                            <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_income_file_tax_return_yes" name="p_income_file_tax_return" value="1" class="LoNotSensitive patient-enroll-progress-3" <?php echo ((in_array('file_tax_return', $radios_submitted) && $data['p_income_file_tax_return'] != '') ? 'preload="' . (int) $data['p_income_file_tax_return'] . '"' : ''); ?> data-step-enroll="3">
                                            <span class="rb-checkmark"></span>
                                        </label>
                                        <label for="p_income_file_tax_return_no" class='rb-container no_width'>No
                                            <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_income_file_tax_return_no" name="p_income_file_tax_return" value="0" class="LoNotSensitive patient-enroll-progress-3" data-step-enroll="3">
                                            <span class="rb-checkmark"></span>
                                        </label>
                                    </div>
                                ...
                                <div class="radio-group">
                                    ...
                                    <div class="full-width align-left">
                                        <input data-hj-allow="true" type="hidden" data-f-count="2" data-fl_1="p_uscitizen_yes" data-fl_2="p_uscitizen_no" class="patient-enroll-progress-3" data-step-enroll="3">
                                        <label for="p_uscitizen_yes" class='rb-container no_width'>Yes
                                            <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_uscitizen_yes" name="p_uscitizen" value="1" class="LoNotSensitive patient-enroll-progress-3" <?php echo ((in_array('us_citizen', $radios_submitted) && $data['p_uscitizen'] != '') ? 'preload="' . (int) $data['p_uscitizen'] . '"' : ''); ?> data-step-enroll="3">
                                            <span class="rb-checkmark"></span>
                                        </label>
                                        <label for="p_uscitizen_no" class='rb-container no_width'>No
                                            <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_uscitizen_no" name="p_uscitizen" value="0" class="LoNotSensitive patient-enroll-progress-3" data-step-enroll="3">
                                            <span class="rb-checkmark"></span>
                                        </label>
                                    </div>
                                ...
                                <div id="patient_income_section" class="hidden">
                                   <!--  <p class="normal align-left">
                                    ...
                                    <div class="patient_income_yes_only">
                                        ...
                                        <div class="full-width">
                                            <select data-hj-allow="true" data-type="patient" id="p_employment_status" name="p_employment_status" preload="<?php echo $data['p_employment_status']; ?>" class="full-width no-float-label LoNotSensitive" title="Are you currently employed?" placeholder="Are you currently employed?">
                                                <option value=''></option>
                                                <option value='F'>Full-Time</option>
                                                <option value='P'>Part-Time</option>
                                                <option value='R'>Retired</option>
                                    ...
                                    <div class="v_box-field">
                                        ...
                                        <div class="full-width">
                                            <select data-hj-allow="true" data-type="patient" name="p_married" id="p_married" preload="<?php echo $data['p_married']; ?>" class="full-width no-float-label LoNotSensitive patient-enroll-progress-3" data-step-enroll="3" title="Are you married?" placeholder="Are you married?">
                                                <option value=''></option>
                                                <option value='S'>Single</option>
                                                <option value='M'>Married</option>
                                                <option value='D'>Separated</option>
                                    ...
                                    <div class="v_box-field">
                                        ...
                                        <div class="full-width">
                                            <select data-hj-allow="true" data-type="patient" name="p_household" id="p_household" preload="<?php echo $data['p_household']; ?>" class="full-width no-float-label LoNotSensitive" title="How many people live in your household?" placeholder="How many people live in your household?">
                                                <option value=''></option>
                                                <?php for ($i = 1; $i < 11; $i++) { ?>
                                                    <option value='<?= $i ?>'><?= $i ?></option>
                                                <?php } ?>
                                    ...
                                    <div class="patient_income_yes_only_div">
                                        ...
                                        <div class="radio-group p_medicaid_2nd">
                                            ...
                                            <div class="full-width align-left">
                                                ...
                                                <label for="p_lis_no" class='rb-container no_width'>No
                                                    <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_lis_no"  name="p_lis" value="0" checked="" class="radio-groups LoNotSensitive">
                                                    <span class="rb-checkmark"></span>
                                                </label>
                                            </div>
                                            <br>
                                        ...
                                        <div class="radio-group">
                                            ...
                                            <div class="full-width align-left">
                                                <label for="p_disabled_status_yes" class='rb-container no_width'>Yes
                                                    <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_disabled_status_yes" name="p_disabled_status" value="1" class="radio-groups LoNotSensitive" <?php echo ((in_array('disabled', $radios_submitted) && $data['p_disabled_status'] != '') ? 'preload="' . (int) $data['p_disabled_status'] . '"' : ''); ?>>
                                                    <span class="rb-checkmark"></span>
                                                </label>
                                                <label for="p_disabled_status_no" class='rb-container no_width'>No
                                                    <input data-hj-allow="true" autocomplete="nope" type="radio" data-type="patient" id="p_disabled_status_no" name="p_disabled_status" value="0" class="radio-groups LoNotSensitive">
                                                    <span class="rb-checkmark"></span>
                                                </label>
                                            </div>
                                            <br>
                                    ...
                                    <div class="patient_income_yes_only">
                                        ...
                                        <div class="p_income_salary full-width relative hidden">
                                            ...
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_income_salary" id="p_income_salary" value="<?= (($data['p_income_salary'] != '' && $data['p_income_salary'] != 0) ? number_format(preg_replace("/[^0-9.]/", "", $data['p_income_salary']), 2, '.', ',') : '') ?>" class="dollar-amount input_zero no-float-label LoNotSensitive">
                                        </div>
                                        <div class="align-left">
                                            <label for="p_has_unemployment" class="cb-container checkbox-label">Monthly Unemployment Income
                                                <input data-hj-allow="true" autocomplete="nope" type="checkbox" data-type="patient" id="p_has_unemployment" name="p_has_unemployment" value="1" <?php echo (($data['p_income_unemployment'] != '' && $data['p_income_unemployment'] != 0) ? 'checked="checked"' : ''); ?> class="checkbox-normal income_checkbox_field LoNotSensitive">
                                                <span class="cb-checkmark"></span>
                                            </label>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="p_income_unemployment full-width relative hidden">
                                            <div class="inline inline-div-for-inputs">$</div>
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_income_unemployment" id="p_income_unemployment" value="<?= (($data['p_income_unemployment'] != '' && $data['p_income_unemployment'] != 0) ? number_format(preg_replace("/[^0-9.]/", "", $data['p_income_unemployment']), 2, '.', ',') : '') ?>" class="dollar-amount input_zero no-float-label LoNotSensitive">
                                        </div>
                                        <div class="align-left">
                                            <label for="p_has_pension" class="cb-container checkbox-label">Monthly Pension Income
                                                <input data-hj-allow="true" autocomplete="nope" type="checkbox" data-type="patient" id="p_has_pension" name="p_has_pension" value="1" <?php echo (($data['p_income_pension'] != '' && $data['p_income_pension'] != 0) ? 'checked="checked"' : ''); ?> class="checkbox-normal income_checkbox_field LoNotSensitive">
                                                <span class="cb-checkmark"></span>
                                            </label>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="p_income_pension full-width relative hidden">
                                            <div class="inline inline-div-for-inputs">$</div>
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_income_pension" id="p_income_pension" value="<?= (($data['p_income_pension'] != '' && $data['p_income_pension'] != 0) ? number_format(preg_replace("/[^0-9.]/", "", $data['p_income_pension']), 2, '.', ',') : '') ?>" class="dollar-amount input_zero no-float-label LoNotSensitive">
                                        </div>
                                        <div class="align-left">
                                            <label for="p_has_annuity" class="cb-container checkbox-label">Monthly Annuity/IRA Income
                                                <input data-hj-allow="true" autocomplete="nope" type="checkbox" data-type="patient" id="p_has_annuity" name="p_has_annuity" value="1" <?php echo (($data['p_income_annuity'] != '' && $data['p_income_annuity'] != 0) ? 'checked="checked"' : ''); ?> class="checkbox-normal income_checkbox_field LoNotSensitive">
                                                <span class="cb-checkmark"></span>
                                            </label>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="p_income_annuity full-width relative hidden">
                                            <div class="inline inline-div-for-inputs">$</div>
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_income_annuity" id="p_income_annuity" value="<?= (($data['p_income_annuity'] != '' && $data['p_income_annuity'] != 0) ? number_format(preg_replace("/[^0-9.]/", "", $data['p_income_annuity']), 2, '.', ',') : '') ?>" class="dollar-amount input_zero no-float-label LoNotSensitive">
                                        </div>
                                        <div class="align-left">
                                            <label for="p_has_ss_retirement" class="cb-container checkbox-label">Monthly Social Security Retirement Income
                                                <input data-hj-allow="true" autocomplete="nope" type="checkbox" data-type="patient" id="p_has_ss_retirement" name="p_has_ss_retirement" value="1" <?php echo (($data['p_income_ss_retirement'] != '' && $data['p_income_ss_retirement'] != 0) ? 'checked="checked"' : ''); ?> class="checkbox-normal income_checkbox_field LoNotSensitive">
                                                <span class="cb-checkmark"></span>
                                            </label>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="p_income_ss_retirement full-width relative hidden">
                                            <div class="inline inline-div-for-inputs">$</div>
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_income_ss_retirement" id="p_income_ss_retirement" value="<?= (($data['p_income_ss_retirement'] != '' && $data['p_income_ss_retirement'] != 0) ? number_format(preg_replace("/[^0-9.]/", "", $data['p_income_ss_retirement']), 2, '.', ',') : '') ?>" class="dollar-amount input_zero no-float-label LoNotSensitive">
                                        </div>
                                        <div class="align-left">
                                            <label for="p_has_ss_disability" class="cb-container checkbox-label">Monthly Social Security Disability Income
                                                <input data-hj-allow="true" autocomplete="nope" type="checkbox" data-type="patient" id="p_has_ss_disability" name="p_has_ss_disability" value="1" <?php echo (($data['p_income_ss_disability'] != '' && $data['p_income_ss_disability'] != 0) ? 'checked="checked"' : ''); ?> class="checkbox-normal income_checkbox_field LoNotSensitive">
                                                <span class="cb-checkmark"></span>
                                            </label>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="p_income_ss_disability full-width relative hidden">
                                            <div class="inline inline-div-for-inputs">$</div>
                                            <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_income_ss_disability" id="p_income_ss_disability" value="<?= (($data['p_income_ss_disability'] != '' && $data['p_income_ss_disability'] != 0) ? number_format(preg_replace("/[^0-9.]/", "", $data['p_income_ss_disability']), 2, '.', ',') : '') ?>" class="dollar-amount input_zero no-float-label LoNotSensitive">
                                        </div>
                                        <div class="hideme">
                        ...
                        <div class="tab-1">
                            ...
                            <div class="tab-container col-sm-7 col-xs-12">
                                <ul id="myTabs" class=" col-sm-7 tab-section-tab nav nav-pills nav-justified" role="tablist" data-tabs="tabs">
                                    ...
                                    <?php } ?>    
                                    <li>
                                        <a href="#Events" name="bAddANewDoctor" id="bAddANewDoctor"><span class="label">Healthcare Provider</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                            <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                                            </svg>
                                        </a>
                                    </li>
                                ...
                                <div class="col-sm-7 card-form">
                                            ...
                                            <?php if ((count($data['doctors']) > 1 && $doctor['doctor_first_name'] != '' && $doctor['doctor_last_name'] != '') || count($data['doctors']) == 1) { ?>
                                                ...
                                                <div old-id="doctor_form" role="tabpanel" class="dr-form tab-pane fade in <?php echo $addClass; ?>" id="pb<?= ($valid_drs) ?>">
                                                    ...
                                                    <div class="col-sm-7 card-form">
                                                        <div>
                                                            <div class="form-group">		
                                                                <div class="full-width doctor-fname-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_first_name[<?= $valid_drs ?>]" value="<?= $doctor['doctor_first_name'] ?>" class="doctor_first_name-<?= $valid_drs ?> dr-required dr-data doctor-fields LoNotSensitive patient-enroll-progress-4" placeholder="Healthcare Provider First Name *" title="Healthcare Provider First Name *" data-step-enroll="4"></div>
                                                            </div>
                                                            <div class="form-group">	
                                                                <div class="full-width doctor-lname-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_last_name[<?= $valid_drs ?>]" value="<?= $doctor['doctor_last_name'] ?>" class="doctor_last_name-<?= $valid_drs ?> dr-required dr-data doctor-lname-fields LoNotSensitive patient-enroll-progress-4" placeholder="Healthcare Provider Last Name *" title="Healthcare Provider Last Name *" data-step-enroll="4"></div>
                                                            </div>	
                                                        </div>

                                                        <div>	

                                                            <div class="full-width doctor-facility-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_facility[<?= $valid_drs ?>]" value="<?= $doctor['doctor_facility'] ?>" class="doctor_facility-<?= $valid_drs ?> dr-data LoNotSensitive" placeholder="Facility Name" title="Facility Name"></div>
                                                            <div class="full-width doctor-address-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_address[<?= $valid_drs ?>]" value="<?= $doctor['doctor_address'] ?>" class="doctor_address-<?= $valid_drs ?> dr-required dr-data dr-address LoNotSensitive patient-enroll-progress-4" placeholder="Address *" title="Address *" rel="" data-step-enroll="4"></div>
                                                        </div>

                                                        <div>										
                                                            <div class="half-width doctor-address2-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_address2[<?= $valid_drs ?>]" value="<?= $doctor['doctor_address2'] ?>" class="doctor_address2-<?= $valid_drs ?> dr-data LoNotSensitive" placeholder="Suite Number" title="Suite Number"></div>
                                                            <div class="half-width doctor-city-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_city[<?= $valid_drs ?>]" value="<?= $doctor['doctor_city'] ?>" class="doctor_city-<?= $valid_drs ?> dr-required dr-data LoNotSensitive patient-enroll-progress-4" placeholder="City *" title="City *" data-step-enroll="4"></div>
                                                        </div>									

                                                        <div>										
                                                            <div class="half-width doctor-state-field">
                                                                <select data-hj-allow="true" name="doctor_state[<?= $valid_drs ?>]" id="doctor_state[<?= $valid_drs ?>]" preload="<?= $doctor['doctor_state'] ?>" class="doctor_state-<?= $valid_drs ?> dr-required dr-data full-width LoNotSensitive" placeholder="State *" title="State *">
                                                            ...
                                                            <div class="half-width doctor-zip-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_zip[<?= $valid_drs ?>]" value="<?= $doctor['doctor_zip'] ?>" maxlength="5" class="doctor_zip-<?= $valid_drs ?> dr-required dr-data dr-zip LoNotSensitive patient-enroll-progress-4" placeholder="Zip Code *" title="Zip Code *" data-step-enroll="4"></div>
                                                        </div>									

                                                        <div>										
                                                            <div class="half-width doctor-phone-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_phone[<?= $valid_drs ?>]" value="<?= $doctor['doctor_phone'] ?>" class="doctor_phone-<?= $valid_drs ?> dr-required dr-data dr-phone LoNotSensitive patient-enroll-progress-4" placeholder="Phone Number *" title="Phone Number *" data-step-enroll="4"></div>
                                                            <div class="half-width doctor-fax-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="doctor_fax[<?= $valid_drs ?>]" value="<?= $doctor['doctor_fax'] ?>" class="doctor_fax-<?= $valid_drs ?> dr-data dr-fax LoNotSensitive" placeholder="Fax Number" title="Fax Number"></div>
                                                        </div>
                                                    </div>
                                                    <!-- </div> -->
                                                    ...
                                                    <?php if (isset($newMedicationProviderGroup[$dr_key]) && !empty($newMedicationProviderGroup[$dr_key])): ?>
                                                        ...
                                                        foreach ($newMedicationProviderGroup[$dr_key] as $providerMedication):
                                                            ...
                                                            ?>
                                                            <div class="col-sm-7 card-form cg_medication_form" id="mb<?php echo $newMedicationProviderGroupCount ?>">
                                                                <div class="medication-row tab-pane fade in" role="tabpanel">
                                                                    ...
                                                                    <div>
                                                                        <div class="form-group">		
                                                                            <div class="medication-name-field full-width">
                                                                                <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_name[<?php echo $newMedicationProviderGroupCount ?>]" value="<?php echo $providerMedication['medication_name'] ?>" placeholder="Medication Name *" title="Medication Name *" class="dyn med-data LoNotSensitive med_name patient-enroll-progress-5 clear_vals" data-step-enroll="5">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">			
                                                                            <div class="medication-strength-field full-width">
                                                                                <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_strength[<?php echo $newMedicationProviderGroupCount ?>]" value="<?php echo $providerMedication['medication_strength'] ?>" placeholder="Medication Strength *" title="Medication Strength *" class="dyn med-data LoNotSensitive patient-enroll-progress-5 clear_vals" data-step-enroll="5">
                                                                            </div>
                                                                        </div>	
                                                                    </div>
                                                                    <div>
                                                                        <div class="form-group">		
                                                                            <div class="medication-frequency-field full-width">
                                                                                <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_frequency[<?php echo $newMedicationProviderGroupCount ?>]" value="<?php echo $providerMedication['medication_frequency'] ?>" placeholder="Medication Frequency (ex. daily) *" title="Medication Frequency (ex. daily) *" class="dyn med-data LoNotSensitive patient-enroll-progress-5 clear_vals" data-step-enroll="5">
                                                                            </div>
                                                                        </div>
                                                                        <input data-hj-allow="true" type="hidden" value="<?php echo $dr_key; ?>" autocomplete="nope" name="medication_doctor[<?php echo $newMedicationProviderGroupCount ?>]" class="cg_medication_doctor med-data full-width LoNotSensitive patient-enroll-progress-5">
                                                                    </div>
                                                                    <?php if ($countThis > 1): ?>
                                                                        <div class="remove-div-1"><a href="javascript:void(0);" class="remove_block" id="remove_provider_mb<?php echo $newMedicationProviderGroupCount ?>">X Remove Medication</a></div>
                                                                    <?php endif; ?>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-7 card-form cg_medication_form" id="mb<?php echo $newMedicationProviderGroupCount ?>" >
                                                            <div class="medication-row tab-pane fade in"role="tabpanel">
                                                                ...
                                                                <div>
                                                                    <div class="form-group">		
                                                                        <div class="medication-name-field full-width">
                                                                            <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_name[<?php echo $newMedicationProviderGroupCount ?>]" value="" placeholder="Medication Name *" title="Medication Name *" class="med-data LoNotSensitive med_name patient-enroll-progress-5 clear_vals" data-step-enroll="5">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">			
                                                                        <div class="medication-strength-field full-width">
                                                                            <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_strength[<?php echo $newMedicationProviderGroupCount ?>]" value="" placeholder="Medication Strength *" title="Medication Strength *" class="med-data LoNotSensitive patient-enroll-progress-5 clear_vals" data-step-enroll="5">
                                                                        </div>
                                                                    </div>	
                                                                </div>
                                                                <div>
                                                                    <div class="form-group">		
                                                                        <div class="medication-frequency-field full-width">
                                                                            <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_frequency[<?php echo $newMedicationProviderGroupCount ?>]" value="" placeholder="Medication Frequency (ex. daily) *" title="Medication Frequency (ex. daily) *" class="med-data LoNotSensitive patient-enroll-progress-5 clear_vals" data-step-enroll="5">
                                                                        </div>
                                                                    </div>
                                                                    <input data-hj-allow="true" type="hidden" value="<?php echo $dr_key; ?>" autocomplete="nope" name="medication_doctor[<?php echo $newMedicationProviderGroupCount ?>]" class="cg_medication_doctor med-data full-width LoNotSensitive patient-enroll-progress-5">
                                                                </div>								
                                                    ...
                                                    <div class="cg_addmore_medi_wrap cg_question_wrap" style="<?php echo ($countThis < $countThisMax) ? 'display:none;' : '' ?>">
                                                        <p class="text-primary cg_addmore_medi_text">Do you have another medication to add for this healthcare provider?</p>
                                                        <div class="cg_addmore_medi_actions">
                                                            <button type="button" onclick="addCgMedication(this)" class="btn btn-primary cg_addmore_medi_action yes">Yes</button>
                                                            <button type="button" class="btn btn-primary cg_addmore_medi_action no" onclick="jQuery(this).closest('.dr-form').find('.cg_addmore_provider_wrap').show()">No</button>
                                                        </div>
                                                    </div>


                                                    <div class="cg_addmore_provider_wrap cg_question_wrap" style="display:none;">
                                                        <p class="text-primary cg_addmore_medi_text">Do you have more healthcare providers to add who prescribe other medication for you?</p>
                                                        <div class="cg_addmore_medi_actions">
                                                            <button type="button" onclick="jQuery(this).closest('.cg_addmore_provider_wrap').hide();
                                                                    jQuery('#bAddANewDoctor').trigger('click')" class="btn btn-primary cg_addmore_medi_action yes">Yes</button>
                                                            <button type="button" onclick="jQuery(this).closest('.cg_addmore_provider_wrap').hide();jQuery('#enroll-progress .active').next('li').find('a').trigger('click')" class="btn btn-primary cg_addmore_medi_action no" onclick="confirmMoreProvider(this)">No</button>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="med_info well m-top" id="med_info" style="display: none;">
                                        ...
                                        <p style="color: black;">You are requesting <span class="ct_med_txt">0 medication</span> through Prescription Hope.</p>
                                        <p style="color: black;">In the event you are approved for all of the medications you are requesting, your monthly total will be <span class="total_str">$0</span>.</p>
                                    </div>
                                    <div class=" m-top">
                    ...
                    <div class="cg_addmore_provider_wrap_dumy" style="display: none">
                        ...
                        <div class="cg_addmore_provider_wrap cg_question_wrap" style="display:none;">
                            <p class="text-primary cg_addmore_medi_text">Do you have more healthcare providers to add who prescribe other medication for you?</p>
                            <div class="cg_addmore_medi_actions">
                                <button type="button" onclick="jQuery(this).closest('.cg_addmore_provider_wrap').hide();jQuery('#bAddANewDoctor').trigger('click')" class="btn btn-primary cg_addmore_medi_action yes">Yes</button>
                                <button type="button" onclick="jQuery(this).closest('.cg_addmore_provider_wrap').hide();jQuery('#enroll-progress .active').next('li').find('a').trigger('click')" class="btn btn-primary cg_addmore_medi_action no" onclick="confirmMoreProvider(this)">No</button>
                            </div>
                        </div>
                    </div>
                                            ...
                                            if ($medication['medication_name'] != '' && $medication['medication_strength'] != '' && $medication['medication_frequency'] != '' && (int) $medication['medication_doctor'] != '') {
                                                ...
                                                <div class="medication-row tab-pane fade in <?php echo $addClassMeds; ?>"  id="mb<?php echo $valid_meds ?>" role="tabpanel">
                                                    ...
                                                    <div>
                                                        <div class="form-group">		
                                                            <div class="medication-name-field full-width">
                                                                <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_name[<?= $valid_meds ?>]" value="<?= $medication['medication_name'] ?>" placeholder="Medication Name *" title="Medication Name *"class="med-data LoNotSensitive med_name">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">			
                                                            <div class="medication-strength-field full-width">
                                                                <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_strength[<?= $valid_meds ?>]" value="<?= $medication['medication_strength'] ?>" placeholder="Medication Strength *" title="Medication Strength *" class="med-data LoNotSensitive">
                                                            </div>
                                                        </div>	
                                                    </div>
                                                    <div>
                                                        <div class="form-group">		
                                                            <div class="medication-frequency-field full-width">
                                                                <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_frequency[<?= $valid_meds ?>]" value="<?= $medication['medication_frequency'] ?>" placeholder="Medication Frequency (ex. daily) *" title="Medication Frequency (ex. daily) *" class="med-data LoNotSensitive">
                                                            </div>	
                                                        </div>
                                                        <div class="form-group">			
                                                            <div class="medication-doctor-field full-width select-dropdown">
                                                                <select data-hj-allow="true" autocomplete="nope" name="medication_doctor[<?= $valid_meds ?>]" preload="<?= $medication['medication_doctor'] ?>" class="doctors_dropdown med-data full-width LoNotSensitive" placeholder="Prescribing Healthcare Provider *" title="Prescribing Healthcare Provider *">
                                                                    <option value=""></option>
                                                                </select>
                                                            </div>
                                                        </div>	
                                        ...
                                        <?php if ($valid_meds == 0) { ?>
                                            ...
                                            <div class="medication-row tab-pane fade in active" id="mb1" role="tabpanel">
                                                ...
                                                <div>
                                                    <div class="form-group">		
                                                        <div class="medication-name-field full-width">
                                                            <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_name[1]" value="" placeholder="Medication Name *" title="Medication Name *" class="med-data LoNotSensitive med_name patient-enroll-progress-5" data-step-enroll="5">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">			
                                                        <div class="medication-strength-field full-width">
                                                            <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_strength[1]" value="" placeholder="Medication Strength *" title="Medication Strength *" class="med-data LoNotSensitive patient-enroll-progress-5" data-step-enroll="5">
                                                        </div>
                                                    </div>	
                                                </div>
                                                <div>
                                                    <div class="form-group">		
                                                        <div class="medication-frequency-field full-width">
                                                            <input data-hj-allow="true" autocomplete="nope" type="text" name="medication_frequency[1]" value="" placeholder="Medication Frequency (ex. daily) *" title="Medication Frequency (ex. daily) *" class="med-data LoNotSensitive patient-enroll-progress-5" data-step-enroll="5">
                                                        </div>
                                                    </div>	
                                                    <div class="form-group">		
                                                        <div class="medication-doctor-field full-width select-dropdown">
                                                            <select data-hj-allow="true" autocomplete="nope" name="medication_doctor[1]" class="doctors_dropdown med-data full-width LoNotSensitive patient-enroll-progress-5" placeholder="Prescribing Healthcare Provider *" title="Prescribing Healthcare Provider *" data-step-enroll="5">
                                                                <option value=""></option>
                                                                <?php /* foreach ($data['doctors'] as $dr_key => $doctor) { ?>
                                                                  <?php if ($doctor['doctor_first_name'] != '' && $doctor['doctor_last_name'] != '') { ?>
                                                                  <option value="<?php echo ($dr_key);?>"><?php echo 'Doctor ' . ($dr_key) . ' (' . $doctor['doctor_first_name'] . ' ' . $doctor['doctor_last_name'] . ')';?></option>
                            ...
                            <div class="col-sm-7 card-form">
                                    ...
                                    <div id="med-list-box" style="display: none;">			
                                        <div class="Medication-List">
                                            ...
                                            <div class="responsive-table">
                                                <table id="med_list" class="table table-striped col-sm-10 align-center">
                                                    <tbody>										  
                                                        <tr class="total"><td>Total Monthly Charge</td><td class="total_str">$150.00 x</td></tr>
                                                    </tbody>
                                                </table>							
                                            </div>
                                            <!-- <div class="p-content">
                                    ...
                                    <div class="p-gatway ">
                                        ...
                                        <div id="payment_cc" class=" ">
                                            <div id="cc_number_box">
                                                ...
                                                <input data-hj-allow="true" autocomplete="nope" type="hidden" name="p_cc_type" value="<?php echo $data['p_cc_type']; ?>">
                                                <div class="full-width form-group"><input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_cc_number" value="<?php echo $data['p_cc_number']; ?>" placeholder="Credit Card Number *" title="Credit Card Number *" class="patient-enroll-progress-6" maxlength="16" data-step-enroll="6"></div>
                                            ...
                                            <div>
                                                ...
                                                <div class="half-width">
                                                    <input data-hj-allow="true" autocomplete="nope" type="hidden" name="p_cc_exp_month" value="<?php echo $data['p_cc_exp_month']; ?>">
                                                    <input data-hj-allow="true" autocomplete="nope" type="hidden" name="p_cc_exp_year" value="<?php echo $data['p_cc_exp_year']; ?>">
                                                    <input data-hj-allow="true" autocomplete="nope" type="text" data-type="patient" name="p_cc_exp_date" value="<?= ($data['p_cc_exp_month'] != '' && $data['p_cc_exp_month'] != '') ? $data['p_cc_exp_month'] . '/' . substr($data['p_cc_exp_year'], 2, 2) : '' ?>" maxlength="5" class="patient-enroll-progress-6" placeholder="MM/YY *" title="MM/YY *" data-step-enroll="6">
                                                    <!--select data-type="patient" name="p_cc_exp_month" preload="<?php echo $data['p_cc_exp_month']; ?>" class="full-width" placeholder="Credit Card Expiration Month *">
                                                            <option value=""></option>
                                                            <option value="01">1 - January</option>
                                                            <option value="02">2 - February</option>
                                                ...
                                                <div class="half-width">
                                                    <input data-hj-allow="true" autocomplete="nope" type="password" data-type="patient" name="p_cc_cvv" value="<?php echo $data['p_cc_cvv']; ?>" maxlength="4" placeholder="CVC *" title="CVC *" class="patient-enroll-progress-6" data-step-enroll="6">
                                    <!--select data-type="patient" name="p_cc_exp_year" preload="<?php echo $data['p_cc_exp_year']; ?>" class="full-width" placeholder="Credit Card Expiration Year *">
                                                            <option value=""></option>
                                                    <?php for ($i = 0; $i < 20; $i++) { ?>
                                                                                                                                                    <option value="<?php echo ((int) date('Y') + $i); ?>"><?php echo ((int) date('Y') + $i); ?></option>
                                            ...
                                            <div class="full-width align-left onlyMobile">
                                                <a href="#" data-tooltip="images/cvv14.jpg" class="skipLeave disable-click">What is this?</a>
                                            </div>
                                            <div class="align-left card col-sm-12">
                                                <div class="half-width align-left"><img src="images/cc_mastercard.png"><img src="images/cc_visa.png" class="payment_images_">  <img src="images/cc_amex.png"> <img src="images/cc_discover.png"></div>
                                            ...
                                            <div>	
                                                <div class="full-width doctor-address-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="p_cc_name" value="<?= $data['p_cc_name'] ?>" class=" LoNotSensitive patient-enroll-progress-4" placeholder="Name of Cardholder *" title="Name of Cardholder" rel="" data-step-enroll="4" data-type="patient"></div>
                                                <div class="full-width doctor-address-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="p_cc_address" id="p_cc_address" value="<?= $data['p_cc_address'] ?>" class=" LoNotSensitive patient-enroll-progress-4" placeholder="Address of Cardholder *" title="Address of Cardholder *" rel="" data-step-enroll="4" data-type="patient"></div>
                                            </div>

                                            <div>										
                                                <div class="half-width doctor-address2-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="p_cc_address2" value="<?= $data['p_cc_address2'] ?>" class=" LoNotSensitive" placeholder="Apartment, Suite, Unit, etc. (optional)" title="Suite Number" data-type="patient"></div>
                                                <div class="half-width doctor-city-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="p_cc_city" id="p_cc_city" value="<?= $data['p_cc_city'] ?>" class=" LoNotSensitive patient-enroll-progress-4" placeholder="City of Cardholder *" title="City of Cardholder *" data-step-enroll="4"  data-type="patient"></div>
                                            </div>									

                                            <div>										
                                                <div class="half-width doctor-state-field">
                                                    <select data-hj-allow="true" name="p_cc_state" id="p_cc_state" preload="<?= $data['p_cc_state'] ?>" class=" full-width LoNotSensitive" placeholder="State of Cardholder *" title="State of Cardholder *" data-type="patient">
                                                        <option value="" selected="selected"></option>
                                                        <option value="AL">Alabama</option>
                                                        <option value="AK">Alaska</option>
                                                        <option value="AZ">Arizona</option>
                                                ...
                                                <div class="half-width doctor-zip-field"><input data-hj-allow="true" autocomplete="nope" type="text" name="p_cc_zip" id="p_cc_zip" value="<?= $data['p_cc_zip'] ?>" maxlength="5" class=" LoNotSensitive patient-enroll-progress-4" placeholder="Zip Code of Cardholder *" title="Zip Code of Cardholder *" data-step-enroll="4"  data-type="patient"></div>
                                            </div>
                                ...
                                <div class="term-content">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="right-padding-35 bottom-padding-15 align-left fancy-cb">
                                            <label for="p_service_agreement" class="cb-container big">By clicking here I state I have read and agreed with the above statements <span class="red">*</span>
                                                <input data-hj-allow="true" autocomplete="nope" type="checkbox" data-type="patient" id="p_service_agreement"  name="p_service_agreement" value="1" <?php echo (($data['p_service_agreement'] == 1) ? 'checked="checked"' : ''); ?> class="checkbox-normal LoNotSensitive patient-enroll-progress-6" data-step-enroll="6">
                                                <span class="cb-checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="chkbox-error-blk"><label for="p_service_agreement" class="error"></label></div>
                                        ...
                                        <div class="right-padding-35 bottom-padding-15 align-left fancy-cb">
                                            <label for="p_guaranty_agreement" class="cb-container big">By clicking here I state I have read and agreed with the above statements <span class="red">*</span>
                                                <input data-hj-allow="true" autocomplete="nope" type="checkbox" data-type="patient" id="p_guaranty_agreement"  name="p_guaranty_agreement" value="1" <?php echo (($data['p_guaranty_agreement'] == 1) ? 'checked="checked"' : ''); ?> class="checkbox-normal LoNotSensitive patient-enroll-progress-6" data-step-enroll="6">
                                                <span class="cb-checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="chkbox-error-blk"><label for="p_guaranty_agreement" class="error"></label></div>
                                        ...
                                        <div class="right-padding-35 bottom-padding-15 align-left fancy-cb">
                                            <label for="p_payment_agreement" class="cb-container big">By clicking here I state I have read and agreed with the above statements <span class="red">*</span>
                                                <input data-hj-allow="true" autocomplete="nope" type="checkbox" data-type="patient" id="p_payment_agreement" name="p_payment_agreement" value="1" <?php echo (($data['p_payment_agreement'] == 1) ? 'checked="checked"' : ''); ?> class="checkbox-normal LoNotSensitive patient-enroll-progress-6" data-step-enroll="6">
                                                <span class="cb-checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="chkbox-error-blk"><label for="p_payment_agreement" class="error"></label></div>
                                    ...
                                    <div class="submit-form">
                                        <div class="btn-en-group col-sm-12 submit_button">
                                            <input data-hj-allow="true" autocomplete="nope" type="hidden" name="bSubmit" value="Submit" />	
                                            <input data-hj-allow="true" autocomplete="nope" type="button" name="bSubmit_btn" id="bSubmit" value="Submit" class="btn btn-primary next btn-block mv-10" disabled="disabled">	
                                            <a class="back cg_back" href="javascript:;">Back</a>		
                                        </div>
                                        <input data-hj-allow="true" type="hidden" id="removepb" value="" />				
                                        <div><div id="ttt" style="color: #fff;"></div></div>
                            ...
                            <div class="col-sm-7 card-form">	
                                <div class="form-group">
                                    <div class="full-width m-v-10">
                                        <input data-hj-allow="true" autocomplete="nope" type="text" value="1" class="patient-enroll-progress-7" data-step-enroll="7">
        ...
        setTimeout(function () {
            $('.nav-tabs li.clickable').on('click', function () {
                ...
                setTimeout(function () {
                    ...
                    jQuery('.nav-tabs li.clickable').not('.final-submit-li').removeClass('active completed disabled');
                    $('.nav-tabs li.clickable').each(function (index) {
                        ...
                        if (jQuery(this).is(clickedEl)) {
                            ...
                            jQuery(this).nextAll('li').not('.final-submit-li').addClass('disabled');
                             if(stepNo > maxstep){
                                maxstep = stepNo;
                                jQuery.post("_sync.php", {key: 'p_step_no', value: stepNo, type: 'patient'})
                                .done(function (response) {
...
//    });
    ...
    $('.back').click(function () {
        if (jQuery('.register-form-tab.active').attr('id') == 'settings-s' && jQuery('#myTabsMedication li').index(jQuery('#myTabsMedication li.active')) > 0) {
            jQuery('#myTabsMedication li.active').prev('li').find('a').trigger('click');
        } else if (jQuery('.register-form-tab.active').attr('id') == 'settings-r' && jQuery('#myTabs li').index(jQuery('#myTabs li.active')) > 0) {
