...
<div class="col-md-12 col-sm-12 col-xs-12 brand-name-med-txt">			
                    ...
                    <p>Prescription Hope provides access to over 1500 brand-name medications for only $50 a month per medication
through Prescription Hope's medication access service. There are no other costs associated with our service or your medications.</p>
...
<!--                        <video id="click_data_med_temp" style="height: 280px;
    ...
    <iframe id="click_data_med_temp" allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/853PbD9qqjQ?loop=1&amp;playlist=853PbD9qqjQ"  style="
    height: 280px;
    overflow: hidden;
    text-align: center;
    border-top-right-radius: 20px;
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 get-started-register">			
                    ...
                    <div class="col-sm-12 pull-right">
                        ...
                        <div class="text-content-text"><span>You are a few steps away from saving money on your medication. To begin your enrollment, let's start with some contact information to create your account.</span></div>
...
<div class="container footer">
    ...
    position: relative;
    bottom: -16px;">
            <div class="trustedsite-trustmark loaded" data-type="202" data-width="120" data-height="50" title="TrustedSite Certified" tabindex="0" style="width: 120px; height: 50px; display: inline-block; background-image: url(&quot;https://cdn.ywxi.net/meter/prescriptionhope.com/202.svg?ts=1669685286876&amp;l=en-US&quot;); background-size: contain; background-position: center top; background-repeat: no-repeat; cursor: pointer;"></div>
        </div>
            </div>
    </div>
</div>
