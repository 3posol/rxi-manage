                ...
                <div class="row account_summary_section Dashboard-section">
                                ...
                                <div class="Account-details">
                                    <div class="main_heading-title ">Medications
                                        <?php if ($_SESSION['PLP']['patient']->DateDisenrolled != '' || ($_SESSION['PLP']['patient']->PastDueBalance > 0 && !$billing_information->chargeback)) { ?>
                                            <span class="document_button"><button class="focus_alert_msg btn btn-primary"><a href="javascript:void(0);">VIEW DETAILS</a></button></span>
                                        <?php } else { ?>
                                            <span class="document_button"><button class="btn btn-primary"><a href="<?= $basepath ?>/medication.php">VIEW DETAILS</a></button></span>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        if (count($rxi_med_data->meds) > 0) {
                                            foreach ($rxi_med_data->meds as $meds) {
                                                if ($meds->DrugAppliedFor != '') {
                                                    ?>
                                                    <p><?php echo $meds->DrugAppliedFor ?> (<?php echo $meds->Dosage ?> - <?php echo $meds->Directions ?>)</p>
                                                    <?php
                                                }
                                            }
                                        } else {
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="Account-details border-none p20 text-center">
                                        <?php if ($_SESSION['PLP']['patient']->DateDisenrolled != '' || ($_SESSION['PLP']['patient']->PastDueBalance > 0 && !$billing_information->chargeback)) { ?>
                                            <span class="document_button"><button class="focus_alert_msg btn btn-primary"><a href="javascript:void(0);">EARN A FREE MONTH</a></button></span>
                                        <?php } else { ?>
                                            <span class="document_button">
                                                <a href="" data-toggle="modal" data-target="#get_a_free_month"><button class="btn btn-primary">EARN A FREE MONTH</button></a>
                                            </span>
                                        <?php } ?>
                        ...
                        <div class="account_summary new-medication">
                            ...
                            <div class="row">
                                <div class="Account-details box-section border-none">
                                    ...
                                    <?php if ($_SESSION['PLP']['patient']->DateDisenrolled != '' || ($_SESSION['PLP']['patient']->PastDueBalance > 0 && !$billing_information->chargeback)) { ?>
                                        <input type="text" placeholder="What would you like to add?" class="add_new_med_input" />
                                        <span class="document_button"><a class="add_med_btn" href="javascript:void(0);"><button class="focus_alert_msg btn btn-primary">ADD MEDICATION</button></a></span>
                                    <?php } else { ?>
                                        <input type="text" placeholder="What would you like to add?" name="add_new_med_input" id="add_new_med_input" class="add_new_med_input" />
                                        <span class="document_button"><a id="add_med_btn" class="add_med_btn"><button class="btn btn-primary">ADD MEDICATION</button></a></span>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="account_summary acc-doc-summary">
                            ...
                            <div class="row">
                                <div class="Account-details even">
                                    <div class="heading-title"><p>These documents are requests by the pharmaceutical company that provides your medication.</p></div>
                                </div>
                                <div class="Account-details border-none">
                                    <div class="heading-title tax-sec">
                                            <!-- <p class="price-sec"> -->
                                                    ...
                                                    if (!empty($jsonFiles)) {
                                                        foreach ($jsonFiles as $jsonFile) {
                                                            ...
                                                            foreach ($str_arrs as $str_arr) {
                                                                ...
                                                                ?>
                                                                <p><a data-full-path="" href="#" class="pop" data-href="https://manage.prescriptionhope.com/patients-dashboard/rxi_patient_upload/<?php echo $newStrArr; ?>"><?php
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">              
                                                    <div class="modal-body">
                                                        ...
                                                        <iframe class="imagepreviewpdf"   src="" frameborder='0' width="100%"></iframe>
                                                        <!-- <div class="imagepreviewdoc">									 -->	       	
                                                        <iframe class="imagepreviewdoc" src='' frameborder='0' width="100%"></iframe>
                                                        <!-- </div> -->
                                                    </div>
                            ...
                            <div class="row">	
                                <div class="Account-details">
                                    <div class="main_heading-title">Upload Documents
                                        <span class="document_button hideme"><a href="" data-toggle="modal" data-target="#submit_documents"><button class="btn btn-primary">SUBMIT DOCUMENTS</button></a></span>	
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="Account-details even" style="display:none;">
                                    <div class="heading-title"><p>Requested Documentation</p></div>
                                </div>
                                <div class="Account-details border-none" style="display:none;">
                                    <div class="heading-title tax-sec"><p class="approved">Annual Income Proof</p></div>
                                </div>
                                <div class="Account-details border-none p20 text-center">
                                    <span class="document_button">
                                        <?php if ($_SESSION['PLP']['patient']->DateDisenrolled != '' || ($_SESSION['PLP']['patient']->PastDueBalance > 0 && !$billing_information->chargeback)) { ?>
                                            <a href="javascript:void(0);"><button class="focus_alert_msg btn btn-primary">SUBMIT DOCUMENTS</button></a>
                                        <?php } else { ?>
                                            <a href="" data-toggle="modal" data-target="#submit_documents"><button class="btn btn-primary">SUBMIT DOCUMENTS</button></a>
<?php } ?>										
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="row">	
                                <div class="Account-details">
                                    <div class="main_heading-title ">Billing
                                        <span class="document_button">
                                            <?php if ($_SESSION['PLP']['patient']->DateDisenrolled != '' || ($_SESSION['PLP']['patient']->PastDueBalance > 0 && !$billing_information->chargeback)) { ?>
                                                <button class="focus_alert_msg btn btn-primary"><a href="javascript:void(0);">VIEW DETAILS</a></button>
                                            <?php } else { ?>
                                                <button class="btn btn-primary"><a href="<?= $basepath ?>/billing.php">VIEW DETAILS</a></button>
<?php } ?>	
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="Account-details even">
                                    <div class="heading-title"><p>Last transaction</p></div>
                                </div>
                                <div class="Account-details border-none">
...
<?php if ($_SESSION['PLP']['patient']->PastDueBalance > 0 || count($billing_information->last_transaction) > 0) { ?>
                                                ...
                                                (<?php echo ($_SESSION['PLP']['patient']->PastDueBalance > 0) ? 'Past Due Balance' : 'Paid' ?> - <?php echo date('m/d/Y', strtotime($billing_information->last_transaction->TransactionDate)); ?>)
                                                <?php
                                            } else {
...
<!-- Submit Documents -->
<div class="modal fade" id="submit_documents" tabindex="-1" role="dialog" aria-labelledby="submit_documents" aria-hidden="true">
                    ...
                    <div class="overlay_form-payment">
                        <div class="row zeroed">
                            <div class="col-sm-12 text-center">
                                ...
                                OR
                                <p id="select-area"><input type="file" class="autowidth" name="income_proof[]" id="income_proof" multiple="multiple"/></p>								
                        ...
                        <div class="row"><span class="col-sm-12 info-text">Please do not submit password-protected documents. We keep your information 100% safe and protected. It is secured by 256-bit encryption, the same security banks use. (PDF | Max 50 MB)</span></div>
                        <span class="blue_loader hideme"><img src="<?= $basepath ?>/images/blue-loader.gif"><br></span>
                    </div>
                </div>
                <div class="modal-footer">
                    <p>
                        <input type="submit" class="btn btn-primary upload_btn big-button whiteButton" value="Upload" disabled />
                    </p>
                </div>
            </div>
        </form>
...
<div class="modal fade" id="get_a_free_month" tabindex="-1" role="dialog" aria-labelledby="get_a_free_month" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post" id="getAFreeMonth" name="getAFreeMonth" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="refer_box">
                        <div class="row zeroed">
                            <div class="col-md-12"><p><strong><u>Earn free monthly services</u></strong> for referring others to Prescription Hope.</p></div>
                            <div class="col-md-12"><p>Our patient referral program is simple:</p></div>
                            <div class="col-md-12 cbp_tmlabel">
                                <ul>
                                    <li><strong><u>Refer Others:</u></strong> Tell friends and family about Prescription Hope's medication savings.</li>
                                    <li><strong><u>Referral Becomes Enrolled:</u></strong> When the person you referred gets approved into their patient assistance program through Prescription Hope, you receive a free month.</li>
                                    <li><strong><u>Receive Your Savings:</u></strong> Your account will be updated to reflect the free month of service for the following billing period.</li>
                                </ul>
                            </div>
                            <div class="col-md-12"><p><strong>There is no limit to the number of referrals you can provide.</strong></p></div>
                            <div class="col-md-12"><p><strong>NOTE:</strong> They should enter your full name in the "How did you hear about Prescription Hope" field within our enrollment form, found at prescriptionhope.com.</p></div>
                        </div>						
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="refer_box">
                        <div class="row zeroed">
                            <div class="col-md-12"><p>We appreciate you creating your account with Prescription Hope. To understand how to use the different features in your account, we have created a quick tutorial for you. This tutorial walks you through step by step on how easy it is to use each part of your account. For detailed instructions, please click "Show Me Around" below.</p></div>
                        </div>						
                    </div>
                </div>
                <div class="modal-footer">
                    <div class="text-center">
                        ...
                        <button type="button" class="btn btn-default dismiss_tour" data-dismiss="modal">I Do Not Need Instructions</button>
                    </div>
                </div>
            </div>
        ...
        <div class="overlay_form">
            ...
            <div class="row zeroed">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="autowidth" id="PatientAddress1" autocomplete="new-password" onfocus="this.setAttribute('autocomplete', 'new-password');"/>
                </div>
                <div class="col-sm-6">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    if (isset($user_medi->meds) && !empty($user_medi->meds)): 
                        ...
                        <button type="button" class="btn btn-primary change_dosage_btn" onclick="yesChanges('dosage')">Yes</button>
                        
                        
                            <ul style="display: none" class="change_dosage_list list-group">
                                <?php foreach ($user_medi->meds as $user_med) : ?>
                                    <li class="list-group-item"  onclick="yesChanges('dosage',<?= $user_med->MedAssistDetailID ?>)"><?= $user_med->DrugAppliedFor ?> <?= $user_med->Dosage ?> <i class="far fa-edit"></i></li>
                                <?php endforeach; ?>
                            </ul>
                    ...
                    <button type="button" class="btn btn-primary cg_changes_btn" onclick="yesChanges('provider')">Yes</button>
                </div>
                <!--            <div class="modal-footer">
        ...
        <div class="overlay_form text-center">
            ...
            <div id="formPayBillNewCC">
                <div class="row zeroed" style="line-height:35px;">
                    ...
                    <div class="col-xs-12 col-lg-6 alignRight"><span id="payCCInvoiceNoText"></span><input type="hidden" id="payCCInvoiceNo" value=""/></div>
...
<script>
                        ...
                        var focusOnMsg = <?php echo ($_SESSION['PLP']['patient']->DateDisenrolled != '' || ($_SESSION['PLP']['patient']->PastDueBalance > 0 && !$billing_information->chargeback)) ? 1 : 0; ?>;
...
<?php /* if ($billing_information->chargeback) { ?>
  ...
  <?php } */ ?>
                            ...
                            jQuery("#submitdocuments").on('submit', function (e) {
                                ...
                                if (postData.length > 0 && postData.length <= 5) {
                                    jQuery.ajax({
                                        ...
                                        type: "POST",
                                        data: {income_proof_file: postData},
                                        beforeSend: function () {
                                            jQuery("#msg").fadeOut();
                                        },
                                        success: function (response) {
                                    ...
                                    jQuery("#msg").html('<div class="alert alert-' + type + '"><p>' + message + '</p></div>').fadeIn();
                                    setTimeout(function () {
                                        jQuery("#msg").fadeOut();
                                    }, 2000);
                                } else {
                                        ...
                                        success: function (response) {
                                            ...
                                            if (data.success == true) {
                                                ...
                                                for (var i = 0; i < total_files; i++) {
                                                    ...
                                                    html += '<input type ="hidden" class="uploaded_files" value="' + data.uploaded_files.uploaded_name[i] + '" />';
                                                    html += '<div class="divTableCell"><a target="_blank" href="' + data.uploaded_files.uploaded_url[i] + '" class="file_url">' + data.uploaded_files.name[i] + '</a></div>';
                                                    html += '<div class="divTableCell file-size">' + data.uploaded_files.size[i] + '</div>';
                                                    html += '<div class="divTableCell"><a href="javascript:void();" data-file_name="' + data.uploaded_files.uploaded_name[i] + '" class="remove_pdf"><i class="fa fa-trash-o" aria-hidden="true"></i></a></div>';
                                                    html += '</div>';
                                ...
                                if (file_name != '') {
                                    ...
                                    jQuery.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            var type = (data.success) ? 'success' : 'danger';
                                            if (data.success == true) {
                                                jQuery("input[value='" + data.fileName + "']").parent(".divTableRow").remove();
                                                jQuery("#msg").html('<div class="alert alert-' + type + '"><p>' + data.message + '</p></div>').fadeIn();
                                                setTimeout(function () {
                                                    jQuery("#msg").fadeOut();
                                                }, 2000);
                            ...
                            jQuery("#add_med_btn").click(function () {
                                window.location = '<?= $basepath ?>/medication.php?med_name=' + jQuery("#add_new_med_input").val() + '#add_new_med';
                            });
                            ...
                            jQuery('.pop').on('click', function () {
                                ...
                                if (ext == 'pdf') {
                                    ...
                                    jQuery('.imagepreview').removeAttr('src');
                                    jQuery('#imagemodal').modal('show');
                                    jQuery(clsName).prop('src', 'https://docs.google.com/viewer?url=' + jQuery(this).data('href') + '&embedded=true');
                                    jQuery(clsName).show();
