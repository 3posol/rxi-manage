                                        ...
                                        <div class="heading-title">
                                            ...
                                            <div id="edit_pfname" class="editblk hideme">
                                                <p><small>Preferred Name</small><br/><span>
                                                        <input data-hj-allow="true" type="text" name="pf_name" id="pf_name" placeholder="Preferred Name" value="<?php echo $_SESSION['PLP']['patient']->PreferredName ?>" maxlength="40" />
                                                        ...
                                                        <input data-hj-allow="true" type="button" data-edittype="edit_pfname" class="saveacc" value="Save" />
                                                        <input data-hj-allow="true" type="button" class="close-edit" value="Cancel" />
                                                    </span></p>
                                            </div>
                                        </div>
                                    </div>						
                                        ...
                                        <div class="heading-title">
                                            ...
                                            <div id="edit_pswd" class="editblk hideme">
                                                <p><small>Password</small><br/><span>
                                                        <input data-hj-allow="true" type="password" name="old_pswd" id="old_pswd" placeholder="Current Password" value="" minlength="8" maxlength="20" />
                                                        <input data-hj-allow="true" type="password" name="new_pswd" id="new_pswd" placeholder="New Password" value="" minlength="8" maxlength="20" />
                                                        <input data-hj-allow="true" type="password" name="cnf_pswd" id="cnf_pswd" placeholder="Confirm Password" value="" minlength="8" maxlength="20" />
                                                        <span class="blue_loader hideme"><img src="<?= $basepath ?>/images/blue-loader.gif" /><br/></span>
                                                        <input data-hj-allow="true" type="button" data-edittype="edit_pswd" class="saveacc" value="Save" />
                                                        <input data-hj-allow="true" type="button" class="close-edit" value="Cancel" />
                                                    </span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="heading-title">
                                            ...
                                            <div id="edit_addr" class="editblk hideme">
                                                <p><small>Shipping Address</small><br/><span>
                                                        <input data-hj-allow="true" type="text" name="PatientAddress1" id="PatientAddress1" placeholder="Address" value="<?= $_SESSION['PLP']['patient']->PatientAddress1 ?>" />
                                                        <input data-hj-allow="true" type="text" name="PatientCity_1" id="PatientCity_1" placeholder="City" value="<?= $_SESSION['PLP']['patient']->PatientCity_1 ?>" />
                                                        <!--<input type="text" name="PatientState_1" id="PatientState_1" placeholder="State" value="<?php //$_SESSION['PLP']['patient']->PatientState_1           ?>" />-->
                                                        <select data-hj-allow="true" name="PatientState_1" id="PatientState_1" data-value="<?php echo $_SESSION['PLP']['patient']->PatientState_1; ?>">
                                                        ...
                                                        <input data-hj-allow="true" type="text" name="PatientZip_1" id="PatientZip_1" placeholder="Zipcode" value="<?= $_SESSION['PLP']['patient']->PatientZip_1 ?>" />
                                                        <span class="blue_loader hideme"><img src="<?= $basepath ?>/images/blue-loader.gif" /><br/></span>
                                                        <input data-hj-allow="true" type="button" data-edittype="edit_addr" class="saveacc" value="Save" />
                                                        <input data-hj-allow="true" type="button" class="close-edit" value="Cancel" />
                                                    </span></p>
                                            </div>
                                        </div>
                            ...
                            <div class="account_communication">
                                ...
                                <div class="row">
                                    <div class="Account-details">
                                        <div class="heading-title">
                                            <div class="editacc-main">
                                                <span class="right_section"><a class="contentHeaderLink editacc" href="javascript:void(0);" data-id="edit_enable_2fa"><i class="fa fa-pencil"></i> EDIT </a></span>
                                                <?php
//                                                if(isset($_SESSION['PLP']['patient']->force_login)){
//                                                    $_SESSION['PLP']['patient']->enable_2fa = 1;
//                                                }
                                                if(!isset($_SESSION['PLP']['patient']->enable_2fa)){
                                                    $_SESSION['PLP']['patient']->enable_2fa = 1;
                                                }
                                                ?>
                                                <p><small>2FA Enable</small><br/><span><?php echo (isset($_SESSION['PLP']['patient']->enable_2fa) && $_SESSION['PLP']['patient']->enable_2fa) ? 'On' : 'Off' ?></span></p>
                                            </div>
                                            <div id="edit_enable_2fa" class="editblk hideme">
                                                <p><small>2FA Enable</small><br/><span>

                                                        <label class="switch cg_2fa_label" >
                                                            <input data-hj-allow="true" type="checkbox" value="1" id="togBtn" name="enable_2fa" <?php
                                                            echo (isset($_SESSION['PLP']['patient']->enable_2fa) && $_SESSION['PLP']['patient']->enable_2fa) ? 'checked="checked"' : ''
                                                            ?>>
                                                            <span class="switch_condition">On</span>
                                                        </label>
                                                        <span class="blue_loader hideme"><img src="<?= $basepath ?>/images/blue-loader.gif" /><br/></span>
                                                        <input data-hj-allow="true" type="button" data-edittype="edit_enable_2fa" class="saveacc" value="Save" />
                                                        <input data-hj-allow="true" type="button" class="close-edit" value="Cancel" />
                                                    </span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="heading-title">
                                            ...
                                            <div id="edit_eaddr" class="editblk hideme">
                                                <p><small>Email (Username)</small><br/><span>
                                                        <input data-hj-allow="true" type="text" name="eaddress" id="eaddress" placeholder="Email Address" value="<?php echo $_SESSION['PLP']['patient']->account_username ?>" />
                                                        <span class="blue_loader hideme"><img src="<?= $basepath ?>/images/blue-loader.gif" /><br/></span>
                                                        <input data-hj-allow="true" type="button" data-edittype="edit_eaddr" class="saveacc" value="Save" />
                                                        <input data-hj-allow="true" type="button" class="close-edit" value="Cancel" />
                                                    </span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="heading-title">
                                            ...
                                            <div id="edit_phn" class="editblk hideme">
                                                <p><small>Phone</small><br/><span>
                                                        <input data-hj-allow="true" type="text" name="PatHomePhoneWACFmt_1" id="PatHomePhoneWACFmt_1" placeholder="Phone Number" value="<?php echo $_SESSION['PLP']['patient']->PatHomePhoneWACFmt_1 ?>" />
                                                        <span class="blue_loader hideme"><img src="<?= $basepath ?>/images/blue-loader.gif" /><br/></span>
                                                        <input data-hj-allow="true" type="button" data-edittype="edit_phn" class="saveacc" value="Save" />
                                                        <input data-hj-allow="true" type="button" class="close-edit" value="Cancel" />
                                                    </span></p>
                                            </div>
                                        </div>
                                                ...
                                                <div class="heading-title">
                                                    ...
                                                    <div id="edit_altcont<?= $i ?>" class="editblk hideme">
                                                        <p>
                                                            <small>Alternate Contact <?= $i ?></small><br/>
                                                            <span>				
                                                                <input data-hj-allow="true" type="text" name="<?= $nameKey ?>" id="<?= $nameKey ?>" placeholder="Emergency Contact Name <?= $i ?>" title="Emergency Contact Name <?= $i ?>" value="<?php echo $_SESSION['PLP']['patient']->$nameKey ?>" />
                                                                <input data-hj-allow="true" type="text" name="<?= $phoneKey ?>" id="<?= $phoneKey ?>" placeholder="Emergency Contact Number <?= $i ?>" title="Emergency Contact Number <?= $i ?>" value="<?php echo esc_phone($_SESSION['PLP']['patient']->$phoneKey) ?>" />
                                                                <span class="blue_loader hideme"><img src="<?= $basepath ?>/images/blue-loader.gif" /><br/></span>
                                                                <input data-hj-allow="true" type="button" data-edittype="edit_altcont<?= $i ?>" class="saveacc" value="Save" />
                                                                <input data-hj-allow="true" type="button" class="close-edit" value="Cancel" />
                                                            </span>
                                                        </p>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="Account-details">
                                        <div class="heading-title">
                                            <?php
                                            $onOffTxt = 'Off';
                                            if (isset($patient_data['metadata'][0]) && $patient_data['metadata'][0]->accessibility != '') {
                                                if ($patient_data['metadata'][0]->accessibility == 1) {
                                                    $onOffTxt = 'On';
                                                    $onOffChecked = 'checked';
                                                } else {
                                                    $onOffTxt = 'Off';
                                                    $onOffChecked = '';
                                                }
                                            ...
                                            <div class="onoffswitch">
                                                <input data-hj-allow="true" type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch" <?php echo $onOffChecked ?> />
                                ...
                                <div class="row">
                                    <div class="Account-details">
                                        <div class="heading-title">
                                            ...
                                            <?php $dob = (isset($_SESSION['PLP']['patient']->PatientDOB))? $_SESSION['PLP']['patient']->PatientDOB : $_SESSION['PLP']['patient']->dob; ?>
                                            <p><small>Date of Birth</small><br/><span><?php echo date('F j, Y', strtotime($dob)) ?></span></p>								
                                        </div>
                                    </div>
                                    <?php
                                        ...
                                        <div class="heading-title">
                                            ...
                                            <div id="edit_allergy" class="editblk hideme">
                                                <p><small>Add your allergies (comma separated)</small><br/><span>
                                                        ...
                                                        <span class="blue_loader hideme"><img src="<?= $basepath ?>/images/blue-loader.gif" /><br/></span>
                                                        <input data-hj-allow="true" type="button" data-edittype="edit_allergy" class="saveacc" value="Save" />
                                                        <input data-hj-allow="true" type="button" class="close-edit" value="Cancel" />
                                                    </span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="heading-title">
                                            ...
                                            <div id="edit_conditions" class="editblk hideme">
                                                <p><small>Add your medical conditions (comma separated)</small><br/><span>
                                                        ...
                                                        <span class="blue_loader hideme"><img src="<?= $basepath ?>/images/blue-loader.gif" /><br/></span>
                                                        <input data-hj-allow="true" type="button" data-edittype="edit_conditions" class="saveacc" value="Save" />
                                                        <input data-hj-allow="true" type="button" class="close-edit" value="Cancel" />
                                                    </span></p>
                                            </div>
                                        </div>
        ...
        <form method="post" id="changeimage" name="changeimage" enctype="multipart/form-data">
            <div class="modal-content">
                    ...
                    <div class="overlay_form-payment">
                        <div class="row zeroed">
                            <div class="col-sm-12 text-center">
                                ...
                                OR
                                <p id="select-area"><input data-hj-allow="true" type="file" class="autowidth" name="profile_image" id="profile_image" placeholder="Select a profile image"></p>								
                                <input data-hj-allow="true" type="hidden" id="action" name="action" value="save_profile_image" />
                                <input data-hj-allow="true" type="hidden" id="p_id" name="p_id" value="<?php echo $_SESSION['PLP']['patient']->PatientID ?>" />
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <input data-hj-allow="true" type="submit" class="btn btn-primary" value="Save" />
                </div>
            </div>
        </form>
    </div>
        ...
        <div class="overlay_form">
            ...
            <div class="row zeroed">
                <div class="col-sm-6">
                    ...
                    <input data-hj-allow="true" type="text" class="autowidth numeric" id="cc_number" maxlength="16"/>
                </div>
                <div class="col-sm-6">
                    <b>Credit Card Type<font class="red">*</font></b><br>
                    <select data-hj-allow="true" name="cc_type" id="cc_type" class="form-control login-portal">
                        <option value=""></option>
            ...
            <div class="row zeroed">
                <div class="col-sm-6">
                    ...
                    <input data-hj-allow="true" type="text" class="autowidth exp_date" id="cc_exp"/>
                </div>
                <div class="col-sm-6">
                    <b>CVV<font class="red">*</font></b><span class="question" data-tooltipTarget="cvvCode">?</span><br>
                    <input data-hj-allow="true" type="text" class="autowidth numeric" id="cc_cvv" maxlength="4"/>
                </div>
            </div>
            ...
            <div class="row zeroed">
                <div class="col-sm-6">
                    ...
                    <input data-hj-allow="true" type="text" class="autowidth" id="PatientFirstNameBilling"/>
                </div>
                <div class="col-sm-6">
                    <b>Last Name<font class="red">*</font></b><br>
                    <input data-hj-allow="true" type="text" class="autowidth" id="PatientLastNameBilling"/>
                </div>
            </div>
            ...
            <div class="row zeroed">
                <div class="col-sm-6">
                    ...
                    <input data-hj-allow="true" type="text" class="autowidth" id="PatientAddress1Billing" autocomplete="new-password"/>
                </div>
                <div class="col-sm-6">
                    <b>Address Line 2</b><br>
                    <input data-hj-allow="true" type="text" class="autowidth" id="PatientAddress2Billing"/>
                </div>
            </div>
            ...
            <div class="row zeroed">
                <div class="col-sm-4">
                    ...
                    <input data-hj-allow="true" type="text" class="autowidth" id="PatientCity_1Billing"/>
                </div>
                <div class="col-sm-4">
                    <b>State<font class="red">*</font></b><br>

                    <select data-hj-allow="true" name="PatientState_1Billing" id="PatientState_1Billing" class="autowidth form-control login-portal">
                        <option value="AL">Alabama</option>
                        <option value="AK">Alaska</option>
                        <option value="AZ">Arizona</option>
                        <option value="AR">Arkansas</option>
                ...
                <div class="col-sm-4">
                    ...
                    <input data-hj-allow="true" type="text" class="autowidth numeric" id="PatientZip_1Billing" maxlength="5"/>
                </div>
            </div>
        ...
        <div class="overlay_form">
            ...
            <div id="formScheduleBill">
                <div class="row" style="line-height:35px;">
                    ...
                    <div class="col-xs-12 col-lg-7 alignRight"><span id="ScheduleInvoiceNumber"><?= $last_invoice_no ?></span><input data-hj-allow="true" type="hidden" id="schedule_number" value="<?= $last_invoice_no ?>"/></div>
                </div>
                <div class="row" style="line-height:35px;">
                ...
                <div class="row" style="line-height:35px;">
                    ...
                    <div class="col-xs-12 col-lg-7 alignRight"><input data-hj-allow="true" type="text" class="date alignRight" id="schedule_date" data-toggle="datepicker"/></div>
                </div>
            </div>
...
<div id="overlay_make_payment" class="overlay_content">
    <div class="overlay_loaded_content">
        <div class="overlay_form text-center">
            ...
            <input data-hj-allow="true" type='hidden' id='payInvoiceNo' value=''>
            <input data-hj-allow="true" type='hidden' id='payInvoiceAmount' value=''>
            <br>
        ...
        <div class="overlay_form text-center">
            ...
            <div id="formPayBillNewCC">
                <div class="row zeroed" style="line-height:35px;">
                    ...
                    <div class="col-xs-12 col-lg-6 alignRight"><span id="payCCInvoiceNoText"></span><input data-hj-allow="true" type="hidden" id="payCCInvoiceNo" value=""/></div class="col-xs-12 col-lg-6 alignRight">
                </div>
                <div class="row zeroed" style="line-height:35px;">
                    <div class="col-xs-12 col-lg-6 alignLeft"><b>Invoice Amount</b></div>
                    <div class="col-xs-12 col-lg-6 alignRight">$<span id="payCCInvoiceAmountText"></span><input data-hj-allow="true" type="hidden" id="payCCInvoiceAmount" value=""/></div>
                </div>
                <div class="row zeroed" style="line-height:35px;">
                    ...
                    <div class="col-xs-12 col-lg-6 alignRight">
                        <select data-hj-allow="true" name="payCCType" id="payCCType" class="form-control login-portal">
                            <option value=""></option>
                            <option value="A">American Express</option>
                            <option value="D">Discover</option>
                            <option value="M">Mastercard</option>
                ...
                <div class="row zeroed" style="line-height:35px;">
                    ...
                    <div class="col-xs-12 col-lg-6 alignRight"><input data-hj-allow="true" type="text" class="autowidth numeric" id="payCCNumber" maxlength="16"/></div>
                </div>
                <div class="row zeroed" style="line-height:35px;">
                    <div class="col-xs-12 col-lg-6 alignLeft m10"><b>Credit Card Expiration Month<font class="red">*</font></b></div>
                    <div class="col-xs-12 col-lg-6 alignRight">
                        <select data-hj-allow="true" name="payCCExpMonth" id="payCCExpMonth" class="form-control login-portal">
                            <option value=""></option>
                ...
                <div class="row zeroed" style="line-height:35px;">
                    ...
                    <div class="col-xs-12 col-lg-6 alignRight">
                        <select data-hj-allow="true" name="payCCExpYear" id="payCCExpYear" class="form-control login-portal">
                            <option value=""></option>
    ...
    <div class="overlay_loaded_content text-center">
        <div class="overlay_form text-center">
            ...
            <div id="dragandrophandler">
                ...
                <br><br>
                <input data-hj-allow="true" type="file" class="" id="incomeProof" name="" />
                <br>
            </div>
        </div>
        <br>
...
<?php /* if ($billing_information->chargeback) { ?>
  ...
  <?php } */ ?>
        ...
        if (!iOS) {
            ...
            }, "Please use upper & lower case letters and numbers.");
