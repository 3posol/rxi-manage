    ...
    <div class="navbar-collapse" id="mainNavbarCollapse">
        <ul class="nav navbar-nav" id="menu">
            <li class="nav-item" id="dashboard">
                ...
                <a class="header_icon_box_off <?=$class?>" href="dashboard.php"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="22px" height="22px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
        ...
        <ul class="pull-lg-right">
            <li class="nav-item dropdown"><a class="nav-link" id="navbarDropdown1" data-target="#" href="<?php echo ($_SESSION['PLP']['patient']->DateDisenrolled != '') ? 'javascript:void(0);' : 'account.php'?>">Account Setting</a></li>
            <li class="profile-image-content"><a class="Profile" href="#"><?php echo $_SESSION['PLP']['patient']->PreferredName ?></a></li>
