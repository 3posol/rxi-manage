...
//echo getcwd();
require('/var/www/html/patients-dashboard/fpdf/fpdf.php');
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
       // echo "The file ". basename( $_FILES["fileToUpload"]["name"]). " has been uploaded.";
         ...
         $pdf_file_name = time().'.pdf';
            ...
            array_pop($url);
            $final_url =  implode('/', $url); 
            $targetDir = "uploads/".$_SESSION['PLP']['patient']->PatientID;
            $folder_url = $final_url.'/'.$targetDir;
            
            $file_url = 'https://manage.prescriptionhope.com/patients-dashboard/uploads/'.$pdf_file_name;
