...
if (isset($_POST['income_proof_file'])) {
	...
	foreach ($_POST['income_proof_file'] as $key => $file) {
		...
		$patient_data['income_proof_file'][] = base64_encode(file_get_contents($file_url, false, stream_context_create($arrContextOptions)));
	}
	$api_data = array(
