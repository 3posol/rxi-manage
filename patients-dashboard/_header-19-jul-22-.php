  ...
  <nav class="navbar navbar-default navbar-fixed-top header-nav" role="navigation">
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <div class="only-mobile right hiddens" style="line-height: 50px;">
          <?php if ($patient_logged_in) { ?>
              <a href="logout.php" class="top-menu-login my-account-link1" style="margin-right: 15px; color: #fff;">Log out</a>
          <?php } ?>
        </div>
      </div>
      <div class="only-mobile">
        ...
        <div class="hidden collapse navbar-collapse navbar-ex1-collapse">
          <ul id="menu-mobile-menu" class="nav navbar-nav">
            ...
            <?php if ($patient_logged_in) { ?>
              <li id="menu-item-47" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-47 top-item"><a href="logout.php">Log out</a></li>
            <?php } ?>
          </ul>
        </div>
      </div>
      ...
      <div class="right only-desktop nav-conatiner">
		...
		<div class="log-in">
		 <?php if ($patient_logged_in) { ?>
              <a href="logout.php" class="top-menu-login my-account-link1" style="">Log out</a>
          <?php } ?>
		  </div>
      </div>
    </div>
