        ...
        <div class="force_login_content col-sm-12 col-md-12">
            <div class="force_login_message">
                <div class="alert alert-danger" role="alert">
                    <a class="not_href_rmv" href="/enrollment/enroll.php?iframe=1" data-hj-allow-iframe="true" data-featherlight-iframe-width="1400" data-featherlight-iframe-height="900" data-featherlight="iframe"><p>Please complete Enrollment form in order to get approved. <u>Click here</u> to finish enrollment form.</p></a>
                </div>
