...
// <!-- change color of message tabs on incomplete enrollment -->
if (isset($_SESSION['incomplete_application_org']) && $_SESSION['incomplete_application_org'] == 0) {
  
if ($heading_message_data->success == 1) {
    ?>
    <div class="alert alert-info cb_disabled_container" role="alert" style="text-align: center;">
        <?php
...
<div class="row new_vcf_msg">
    <!--<div class="col-sm-6 col-md-6 new_vcf_msg_coved">
    ...
    <div class="col-sm-6 col-md-6 new_vcf_msg_coved">
        <div class="alert alert-info cb-alert-info" role="alert">
            <span class="img"><img src="images\megaphone.png"></span>
            <span class="test">Our offices will be closed on Wednesday and Thursday of this week due to Hurricane Nicole and Friday in observance of the Veteran’s Day holiday.</span>
        </div>
    </div>-->
    <div class="col-sm-12 col-md-12 new_vcf_msg_download cb_disabled_container">
        <div class="alert alert-success cb-alert-info cb_disabled_container" role="alert" style="text-align: center;">
...
<div class="row new_vcf_msg">
    ...
    <div class="col-sm-12 col-md-12 new_vcf_msg_download">
