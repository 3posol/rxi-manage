	...
	<div class="container twoColumnContainerNo">
		...
		<div class="row no-marginNo">
			...
			<div class="col-sm-12 leftIconBox" style="padding-top:15px;">
				...
				<?php if(isset($event_information->success)) {
						...
						<div class="account_summary">
							...
							<div class="row">
								...
								<div class="Account-details border-none">
									...
									<?php if( count($rxi_med_data->meds)>0 ) { 	
									...
									} else { echo '<p>No medications found</p>'; }?>
									</div>	
								</div>
							</div>
						</div>
															...
															if(!empty($jsonFiles)) {		
																foreach ($jsonFiles as $jsonFile) {
																	...
																	foreach ($str_arrs as $str_arr) {	
																		...
																		?>
																		<p><a data-full-path="" href="#" class="pop" data-href="https://manage.prescriptionhope.com/patients-dashboard/rxi_patient_upload/<?php echo $newStrArr; ?>"><?php $withoutExt = preg_replace('/\\.[^.\\s]{3,4}$/', '', $str_arr);  echo ucfirst(str_replace("_", " ",$withoutExt)); ?></a></p>
																	<?php $i++;}
																}
								...
								<div class="Account-details border-none">
									<div class="heading-title">
										<p class="price-sec">
											...
											<?php } else { echo 'No billing record found'; } ?>
										</p>
									</div>					
								</div>
							</div>
...
jQuery(document).ready(function() {
	...
	jQuery("#submitdocuments").on('submit', function(e) {
		...
		if(postData.length > 0 && postData.length <=5){
			...
			setTimeout(function(){jQuery("#msg").fadeOut();},2000);
		}else{
			var type = 'danger';
