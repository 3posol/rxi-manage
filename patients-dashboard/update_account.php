...
if (isset($_POST)) {
    ...
    } else if ($input_data['type'] == 'edit_enable_2fa') {
        $command = 'change_2fa';
        $patient_data = array('type' => $input_data['type'], 'enable_2fa' => (isset($input_data['enable_2fa']) && $input_data['enable_2fa'] == 1) ? 1 : 0, 'id' => $_SESSION['PLP']['patient']->PatientID, 'access_code' => $_SESSION['PLP']['access_code']);
    }
    ...
    //}
        ...
        if ($data['PatientFirstName'] != trim($_SESSION['PLP']['patient']->PatientFirstName) || $data['PatientMiddleInitial'] != trim($_SESSION['PLP']['patient']->PatientMiddleInitial) || $data['PatientLastName'] != trim($_SESSION['PLP']['patient']->PatientLastName) || $data['PatientAddress1'] != trim($_SESSION['PLP']['patient']->PatientAddress1) || $data['PatientCity_1'] != trim($_SESSION['PLP']['patient']->PatientCity_1) || $data['PatientState_1'] != trim($_SESSION['PLP']['patient']->PatientState_1) || $data['PatientZip_1'] != trim($_SESSION['PLP']['patient']->PatientZip_1) || $data['PatHomePhoneWACFmt_1'] != trim($_SESSION['PLP']['patient']->PatHomePhoneWACFmt_1) || $data['EmergencyContactName'] != trim($_SESSION['PLP']['patient']->EmergencyContactName) || $data['EmergencyContactPhone'] != trim($_SESSION['PLP']['patient']->EmergencyContactPhone) || $data['EmergencyContact2Name'] != trim($_SESSION['PLP']['patient']->EmergencyContact2Name) || $data['EmergencyContact2Phone'] != trim($_SESSION['PLP']['patient']->EmergencyContact2Phone) || $data['EmergencyContact3Name'] != trim($_SESSION['PLP']['patient']->EmergencyContact3Name) || $data['EmergencyContact3Phone'] != trim($_SESSION['PLP']['patient']->EmergencyContact3Phone) || $data['PreferredName'] != trim($_SESSION['PLP']['patient']->PreferredName) || $data['Allergies'] != trim($_SESSION['PLP']['patient']->Allergies) || $data['Conditions'] != trim($_SESSION['PLP']['patient']->Conditions)
        ) {
