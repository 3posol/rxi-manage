...
function get_agent_price_point ($agent_code) {
	...
	return ($response != '') ? $response : '35.00';
}
			...
			<div id='applicationForm'>
				<?php if (!$form_submitted) { ?>
					...
					<p class="subhead2-blue left-alignment" style="color: #17386f; text-transform: none;">
						The Prescription Hope Pharmacy Program charges a set price of $<?=$_SESSION['rate']?> per month per medication. There are no other costs, fees, or charges associated with your medication on our program. If we are unable to obtain a prescription medication, we will not charge a fee for that medication.
					</p>
