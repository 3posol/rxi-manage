		...
		<div class="container">
			<div id='applicationForm'>
				<?php if (!$form_submitted) { ?>
					...
					<div class="pull-left">
						<p>
							<input type="radio" id="p_payment_method_cc" name="p_payment_method" value="cc" checked="checked" <?php echo (($data['p_payment_method'] != '') ? 'preload="' . $data['p_payment_method'] . '"' : ''); ?>> <label for="p_payment_method_cc" class='no_width'> &nbsp;Visa, Mastercard or Debit Card</label>
							<br clear="all"/>
