...
if ($_SERVER['SERVER_NAME'] == 'localhost') {
    ...
    //RXI Webservice URL
    $RXI_API_URL = "http://localhost/phope/rxi/webservice/cg/api.php";
    ...
    $RXI_API_URL = "http://phope-rxi.manage.prescriptionhope.com/webservice/cg/api.php";
    ...
    $RXI_API_URL = "http://172.31.47.116/webservice/cg/api.php"; // AWS API URL
    //smtp
...
$data_request = array(
    ...
    'p_step_no' => array(false, 1, 'step_no'),
