...
<div class="">
	<h2>All My Affiliate Agents' Book of Business</h2>

	<?php if ($enrolled_patients->success == 1 && count($enrolled_patients->patients) > 0) { ?>
		<a href="affiliate_patients.php?format=xls">Download Excel</a>
		<br/><br/>
		...
		<table>
			<thead class="no-separator">
				<tr>
					...
					<?php } ?>
					<td>Status</td>
					<?php if (!(bool) $_SESSION['annual_commission']) { ?><td>Agent Name</td><?php } ?>
